...
#[inline] pub fn compute_legacy_broadcast_sizes(
    a:    &Tensor, 
    b:    &Tensor, 
    axis: i32) -> (usize,usize,usize) 
{
    todo!();
    /*
        CAFFE_ENFORCE_GE(
...
pub fn compute_binary_broadcast_forward_dims(a_dims: &[i32], b_dims: &[i32]) -> Vec<i32> {
...
#[inline] pub fn compute_binary_broadcast_backward_axes(
    a_dims: &Vec<i32>,
    b_dims: &Vec<i32>,
    a_axes: *mut Vec<i32>,
    b_axes: *mut Vec<i32>)  
...
#[inline] pub fn compute_binary_broadcast_backward_dims(
    a_dims:      &Vec<i32>,
    b_dims:      &Vec<i32>,
    a_back_dims: *mut Vec<i32>,
    b_back_dims: *mut Vec<i32>)  
{
    todo!();
    /*
        const int ndim = std::max(A_dims.size(), B_dims.size());
