...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/test/average-pooling-operator-tester.h]

pub struct AveragePoolingOperatorTester {
...
impl AveragePoolingOperatorTester {
    
    #[inline] pub fn padding(&mut self, padding: u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn padding(&mut self, 
        padding_height: u32,
        padding_width:  u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn padding_height(&mut self, padding_height: u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn padding_width(&mut self, padding_width: u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn padding_top(&mut self, padding_top: u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn padding_right(&mut self, padding_right: u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn padding_bottom(&mut self, padding_bottom: u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn padding_left(&mut self, padding_left: u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn input_size(&mut self, 
        input_height: usize,
        input_width:  usize) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn input_height(&mut self, input_height: usize) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn input_width(&mut self, input_width: usize) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn channels(&mut self, channels: usize) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn batch_size(&mut self, batch_size: usize) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn pooling_size(&mut self, pooling_size: u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn pooling_size(&mut self, 
        pooling_height: u32,
        pooling_width:  u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn pooling_height(&mut self, pooling_height: u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn pooling_width(&mut self, pooling_width: u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn stride(&mut self, stride: u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn stride(&mut self, 
        stride_height: u32,
        stride_width:  u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn stride_height(&mut self, stride_height: u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn stride_width(&mut self, stride_width: u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn input_pixel_stride(&mut self, input_pixel_stride: usize) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn output_pixel_stride(&mut self, output_pixel_stride: usize) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn next_input_size(&mut self, 
        ...
        next_input_width:  u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn next_input_height(&mut self, next_input_height: u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn next_input_width(&mut self, next_input_width: u32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn next_batch_size(&mut self, next_batch_size: usize) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn input_scale(&mut self, input_scale: f32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn input_zero_point(&mut self, input_zero_point: u8) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn output_scale(&mut self, output_scale: f32) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn output_zero_point(&mut self, output_zero_point: u8) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn qmin(&mut self, qmin: u8) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn qmax(&mut self, qmax: u8) -> &mut AveragePoolingOperatorTester {
    ...
    #[inline] pub fn iterations(&mut self, iterations: usize) -> &mut AveragePoolingOperatorTester {
              ...
              for (usize ox = 0; ox < outputWidth(); ox++) {
                for (usize c = 0; c < channels(); c++) {
                  ...
                  for (usize py = 0; py < poolingHeight(); py++) {
                    const usize iy = oy * strideHeight() + py - paddingTop();
                    for (usize px = 0; px < poolingWidth(); px++) {
                      const usize ix = ox * strideWidth() + px - paddingLeft();
