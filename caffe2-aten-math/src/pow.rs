...
#[deprecated = "figure out a better way to handle the overloads"]
pub fn float_power_d<'a>(
        base: &mut Tensor,
        exp:  &Tensor) -> &'a mut Tensor {
...
#[deprecated = "figure out a better way to handle the overloads"]
pub fn float_power_e<'a>(
        base: &mut Tensor,
        exp:  &Scalar) -> &'a mut Tensor {
