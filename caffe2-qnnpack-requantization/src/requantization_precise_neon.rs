...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/src/requantization/precise-neon.c]

pub fn pytorch_qnnp_requantize_precise_neon(
    n:          Size,
    input:      *const i32,
    scale:      f32,
    zero_point: u8,
    ...
    todo!();
      ...
      const i32 shift = 127 + 23 - (scale_bits >> 23);
      assert(shift >= 24);
      assert(shift < 56);
