...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/src/requantization/precise-psimd.c]

pub fn pytorch_qnnp_requantize_precise_psimd(
        n:          Size,
        input:      *const i32,
        scale:      f32,
        zero_point: u8,
    ...
    todo!();
      ...
      const psimd_s32 vzero_point = psimd_splat_s32((i32)(u32)zero_point);
      const psimd_s32 vsmin =
          psimd_splat_s32((i32)(u32)qmin - (i32)(u32)zero_point);
      const psimd_s32 vsmax =
          psimd_splat_s32((i32)(u32)qmax - (i32)(u32)zero_point);
      const psimd_u32 vrounding_lo = psimd_splat_u32((u32)rounding);
      const psimd_u32 vrounding_hi = psimd_splat_u32((u32)(rounding >> 32));
