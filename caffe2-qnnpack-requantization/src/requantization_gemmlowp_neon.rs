...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/src/requantization/gemmlowp-neon.c]

/**
  | The requantization implementation
  | below is adapted from Google's gemmlowp
  | library. It is only used in QNNPACK unit
  | tests and comparative benchmarks,
  ...
  */
pub fn pytorch_qnnp_requantize_gemmlowp_neon(
    n:          Size,
    input:      *const i32,
    scale:      f32,
    zero_point: u8,
