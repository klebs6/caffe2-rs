...
pub const sz: usize = 10000;
pub type array = [f32; sz];

pub const sz_test: usize = 10;
pub type testarray = [f32; sz_test];

#[inline] pub fn isclose(x: f32, y: f32) -> bool {
...
#[inline] pub fn isrelclose(x: f32, y: f32) -> bool {
...
pub fn mse<const N: usize>(a1: &mut [f32; N], a2: &mut [f32; N]) -> f64 {
...
/**
  | minimum representable value of (10 bit
  | mantissa) fp16=6e-5
  |
  | minimum representable value of (7 bit
  | mantissa) bfp16=5e-4
  */
#[inline] pub fn test_case(
    v:       f32,
    v_fp16:  f32,
    v_bfp16: f32)  {
...
#[inline] pub fn test_vector_case(
    v:       f32,
    v_fp16:  f32,
    v_bfp16: f32)  {
