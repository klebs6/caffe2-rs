...
/**
  ...
  |
  */
pub struct KLDivergenceMinimization {
    base: dyn QuantizationErrorMinimization,
}

impl KLDivergenceMinimization {
    ...
    #[inline] pub fn choose_quantization_params(&mut self, 
        ...
        let preserve_sparsity = preserve_sparsity.unwrap_or(false);
