...
/**
  ...
  | we don't want to use scales in fp16 subnormal
  | range.
  |
  | This is to be consistent with Glow and
  | FakeLowP implementation for NNPI.
  */
pub const SMALL_SCALE_THRESHOLD: f32 = 6.1e-5;

#[inline] pub fn get_norm(
    begin:   f32,
    end:     f32,
    density: f32,
    kind:    NormMinimizationKind) -> f32 {
...
impl NormMinimization {
    ...
    #[inline] pub fn choose_quantization_params(&mut self, 
        hist:              &Histogram,
