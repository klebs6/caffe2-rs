...
pub type AddFp32Op<N: Num> = BinaryElementwiseOp<N,CPUContext,AddFunctor<CPUContext>,SameTypeAsInput>;

pub struct AddDNNLowPOp<T, N: Num> {
    ...
    //
    base:                  BinaryElementwiseDNNLowPOp<T, AddFp32Op<N>>,
