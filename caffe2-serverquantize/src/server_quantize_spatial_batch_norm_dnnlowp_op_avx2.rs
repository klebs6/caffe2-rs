...
#[inline] pub fn spatial_bn_nhwc_avx2_uint8<const ReluFused: bool>(
    n:              i32,
    c:              i32,
    hxw:            i32,
    in_zero_point:  i32,
    ...
    /*
        constexpr int kVLen = 8;
                    ...
                    const __m256i min_v = _mm256_set1_epi32(uint8_t::min);
                    const __m256i max_v = _mm256_set1_epi32(uint8_t::max());
...
#[inline] pub fn spatial_bn_nhwc_avx2_u8(
    n:              i32,
    c:              i32,
    hxw:            i32,
    in_zero_point:  i32,
