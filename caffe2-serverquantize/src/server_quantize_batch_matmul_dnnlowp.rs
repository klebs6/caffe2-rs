...
pub struct BatchMatMulDNNLowPOp<T> {
    //USE_OPERATOR_FUNCTIONS(CPUContext);
    //USE_DNNLOWP_OPERATOR_BASE_FUNCTIONS(T, BatchMatMulOp<CPUContext>);
    base:                    DNNLowPOp<T, BatchMatMulOp<CPUContext,DefaultEngine>>,

    trans_a:                 bool,
    trans_b:                 bool,
    broadcast:               bool, // default = false
    is_B_constant:           bool, // default = false

    b_quantized:             Vec<i8>,

    #[cfg(use_fbgemm)]
    bq_packed:               Vec<Box<fbgemm::PackBMatrix<i8>>>,

    a_pack_buf:              Vec<u8>,
    row_offsets:             Vec<i32>,
    column_offsets:          Vec<i32>,

    b_qparams:               Vec<TensorQuantizationParams>,
    requantization_params:   Vec<RequantizationParams>,
    y_int32:                 Vec<i32>,
    first_invocation:        bool, // default = true
}

impl<T> BatchMatMulDNNLowPOp<T> {
    ...
    pub fn new(operator_def: &OperatorDef, ws: *mut Workspace) -> Self {
        ...
        /*
          ...
          is_B_constant_( this->template GetSingleArgument<bool>("constant_B", false))
        */
    }
...
register_cpu_operator_with_engine!{
    BatchMatMul,
    DNNLOWP,
    BatchMatMulDNNLowPOp<u8>
}

register_cpu_operator_with_engine!{
    BatchMatMul,
    DNNLOWP_16,
    BatchMatMulDNNLowPOp<u16>
}
