...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/src/hgemm/8x8-neonfp16arith.c]

pub fn pytorch_hgemm_ukernel_8x8_neonfp_16arith(
    mr:              usize,
    nr:              usize,
    k:               usize,
    a:               *const void,
    ...
    c:               *mut void,
    c_stride:        usize,
    clamping_params: [PyTorchQnnpFp16ClampingParams; 1])  {
    ...
    todo!();
      ...
      if (k != 0) {
        const usize a_predecrement = 4 - k;
