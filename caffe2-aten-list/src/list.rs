...
pub fn swap<T>(
    lhs: ListElementReference<T,ListIterator>,
    rhs: ListElementReference<T,ListIterator>
) {
...
pub struct ListElementReference<T,ListIterator> {
    iterator: ListIterator,
}

impl<T,ListIterator> ListElementReference<T,ListIterator> {
    ...
    pub fn new(iter: ListIterator) -> Self {
...
/**
  ...
  |
  */
pub struct ListIterator<T,ListIterator> {
    base:     ListIterator<RandomAccessIteratorTag,T>,
    iterator: ListIterator,
}

impl<T> Index<usize> for ListIterator<T,ListIterator> {

    type Output = ListElementReference<T,ListIterator>;
...
impl<T> PartialEq<ListIterator> for ListIterator {
...
impl<T> Ord<ListIterator> for ListIterator {
...
impl<T> PartialOrd<ListIterator> for ListIterator {
...
impl<T> ListIterator<T,ListIterator> {
    ...
    pub fn operator_plus_equals(&mut self, offset: ListSizeType) -> &mut ListIterator {
    ...
    pub fn operator_minus_equals(&mut self, offset: ListSizeType) -> &mut ListIterator {
    ...
    pub fn operator_plus(&self, offset: ListSizeType) -> ListIterator {
    ...
    pub fn operator_minus(&self, offset: ListSizeType) -> ListIterator {
    ...
    pub fn operator_mul(&self) -> ListElementReference<T,ListIterator> {
    ...
    pub fn new(iterator: ListIterator) -> Self {
...
pub type ListInternalReferenceType      = ListElementReference<T,ListImpl::list_type::iterator>;
pub type ListInternalConstReferenceType = ListElementConstReferenceTraits<T>::const_reference;
pub type ListValueType                  = T;
pub type ListSizeType                   = ListImpl::list_type::size_type;
pub type ListIterator                   = ListIterator<T,ListImpl::list_type::iterator>;
pub type ListReverseIterator            = ListIterator<T,ListImpl::list_type::reverse_iterator>;

impl<T> Index<ListSizeType> for List<T> {

    type Output = ListInternalConstReferenceType;
...
impl<T> IndexMut<ListSizeType> for List<T> {
...
impl<T> List<T> {
    ...
    /**
      ...
      |
      */
    pub fn get(&self, pos: ListSizeType) -> ListValueType {
    ...
    /**
      ...
      |
      */
    pub fn extract(&self, pos: ListSizeType) -> ListValueType {
    ...
    /**
      ...
      |
      */
    pub fn begin(&self) -> ListIterator {
    ...
    /**
      ...
      |
      */
    pub fn erase(&self, pos: ListIterator) -> ListIterator {
    ...
    pub fn erase(&self, 
        first: ListIterator,
        last:  ListIterator) -> ListIterator {
