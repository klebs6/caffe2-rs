...
#[inline] pub fn cufft_get_plan_cache<'a>(device_index: i64) -> &'a mut CuFFTParamsLRUCache {
...
pub fn fft_apply_normalization<'a>(
        self_:         &Tensor,
        normalization: i64,
        sizes:         &[i32],
        dims:          &[i32]) -> &'a Tensor {
...
pub fn fft_apply_normalization_out<'a>(
        out:           &mut Tensor,
        self_:         &Tensor,
        normalization: i64,
        sizes:         &[i32],
        dims:          &[i32]) -> &'a mut Tensor {
