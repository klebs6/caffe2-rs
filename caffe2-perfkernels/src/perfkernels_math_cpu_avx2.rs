/*!
  ...
  | 
  | The implementation in this file allows
  | us to route the underlying numerical
  | computation library to different compiler
  | options (-mno-avx2 or -mavx2).
  |
  */

crate::ix!();

pub const QEPSILON: f64 = 1e-8;

#[inline] pub fn quantize_and_compress__avx2(
...
#[inline] pub fn decompress_and_dequantize__avx2(
    input_data:  *const u8,
    output_data: *mut f32,
    input_size:  u64) 
{
