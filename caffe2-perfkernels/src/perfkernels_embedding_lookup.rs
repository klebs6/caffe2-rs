 ...
 */
#[inline] pub fn embedding_lookup<IndexType, InType, OutType, const IS_WEIGHT_POSITIONAL: bool>(
    block_size:           i64,
    output_size:          i64,
    index_size:           i64,
    data_size:            i64,
...
/**
  ...
  |
  */
#[inline] pub fn embedding_lookup_generic_slow<IndexType, InType, OutType, const IS_WEIGHT_POSITIONAL: bool>(
    block_size:           i64,
    output_size:          i64,
    index_size:           i64,
    data_size:            i64,
...
#[macro_export] macro_rules! embedding_specialization {
...
embedding_specialization!{i32, f32, f32, f32, false}
embedding_specialization!{i64, f32, f32, f32, false}
embedding_specialization!{i32, f16, f16, f32, false}
embedding_specialization!{i64, f16, f16, f32, false}
embedding_specialization!{i32, u8,  u8,  f32, false}
embedding_specialization!{i64, u8,  u8,  f32, false}

embedding_specialization!{i32, f32, f32, f32, true}
embedding_specialization!{i64, f32, f32, f32, true}
embedding_specialization!{i32, f16, f16, f32, true}
embedding_specialization!{i64, f16, f16, f32, true}
embedding_specialization!{i32, u8,  u8,  f32, true}
embedding_specialization!{i64, u8,  u8,  f32, true}
