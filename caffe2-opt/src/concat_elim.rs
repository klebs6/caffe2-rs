...
#[inline] pub fn concat_elim<T,U>(nn: *mut NNModule<T,U>)  {
...
#[inline] pub fn concat_add_mul_nan_clip_elim<T,U>(nn: *mut NNModule<T,U>)  {
...
#[inline] pub fn gather_fuse_8bit_rowwise_quant_float_mul_lengths_sum_elim<T,U>(nn: *mut NNModule<T,U>)  {
