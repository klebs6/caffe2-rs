...
#[inline] pub fn optimize_for_mkldnn<T,U>(
    ...
    let training_mode = training_mode.unwrap_or(false);
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn get_blob(name: String, ws: *mut Workspace) -> *mut Blob {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn get_blob(node: NNGraph::NodeRef, ws: *mut Workspace) -> *mut Blob {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn get_tensor<T>(blob: *mut Blob) -> T {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn get_mutable_tensor<T>(blob: *mut Blob) -> *mut T {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn get_op_def(nn_op: &NeuralNetOperator) -> &OperatorDef {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn get_mutable_op_def(nn_op: &mut NeuralNetOperator) -> *mut OperatorDef {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn is_op_type(node_ref: &NNGraph::NodeRef, type_name: String) -> bool {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn is_on_ideep_device(nn_op: &NeuralNetOperator) -> bool {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn is_conv_fusion(conv_node: NNGraph::NodeRef, fusion_type: i32) -> bool {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn reset_conv_for_fusion(conv_node: NNGraph::NodeRef, fusion_type: i32)  {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn remove_arg(nn_op: &mut NeuralNetOperator, arg_name: String)  {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn move_op_arg(
    ws:       *mut Workspace,
    arg_name: String,
    src_op:   *mut NeuralNetOperator,
    dst_op:   *mut NeuralNetOperator)  {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn remove_stop_gradient_for_inference<T,U>(nn: *mut NNModule<T,U>, ws: *mut Workspace) -> bool {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn fuse_conv_bnand_aff_ch<T,U>(nn: *mut NNModule<T,U>, ws: *mut Workspace) -> bool {
    ...
    macro_rules! expose_tensor_data {
        ($name:ident, $index:ident, $nodes:ident, $need_init:ident) => {
            todo!();
            /*
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn fuse_conv_sum<T,U>(nn: *mut NNModule<T,U>, ws: *mut Workspace) -> bool {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn fuse_activation<T,U>(nn: *mut NNModule<T,U>, ws: *mut Workspace) -> bool {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn enforce_fusion_inplace<T,U>(nn: *mut NNModule<T,U>, ws: *mut Workspace) -> bool {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn fuse_order_switch_to_quantize_op<T,U>(nn: *mut NNModule<T,U>, ws: *mut Workspace) -> bool {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn fuse_pre_convert_op<T,U>(nn: *mut NNModule<T,U>, ws: *mut Workspace) -> bool {
...
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn set_pooling_inference_mode<T,U>(nn: *mut NNModule<T,U>)  {
...
/**
  | Pre-convert filters format to expected
  | one here in order to avoid boring conversions
  | during computations
  |
  */
#[cfg(caffe2_use_mkldnn)]
#[inline] pub fn pre_convert_filters_format<T,U>(nn: *mut NNModule<T,U>, ws: *mut Workspace)  {
...
/**
  | Fusers for ideep to parse the graph and
  | apply operator fusion
  |
  */
#[cfg(caffe2_use_mkldnn)]
pub type Fuser<T,U> = fn(nn: *mut NNModule<T,U>, ws: *mut Workspace) -> bool;

#[cfg(caffe2_use_mkldnn)]
lazy_static![
    static ref fusers: &'static [Fuser] = &[
