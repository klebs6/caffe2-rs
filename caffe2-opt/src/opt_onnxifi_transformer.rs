...
#[inline] pub fn fill_model_info(model: *mut OnnxModelProto)  {
...
#[inline] pub fn get_blob1st_dim_size(shape_info: &ShapeInfo) -> i64 {
...
#[inline] pub fn compose_result_net(onnxifi_op: &OperatorDef) -> NetDef {
