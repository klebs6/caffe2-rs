...
pub fn quantize_tensor_per_tensor_affine<'a>(
        rtensor:    &Tensor,
        qtensor:    &'a mut Tensor,
        scale:      f64,
        zero_point: i64) -> &'a mut Tensor {
...
pub fn quantize_tensor_per_channel_affine<'a>(
        rtensor:     &Tensor,
        qtensor:     &'a mut Tensor,
        scales:      Tensor,
        zero_points: Tensor,
        axis:        i64) -> &'a mut Tensor {
...
pub fn quantize_tensor_per_channel_float_qparams<'a>(
        rtensor:     &Tensor,
        qtensor:     &'a mut Tensor,
        scales:      Tensor,
        zero_points: Tensor,
...
pub fn dequantize_tensor_per_tensor_affine<'a>(
        qtensor:    &Tensor,
        rtensor:    &mut Tensor,
        scale:      f64,
        zero_point: i64) -> &'a mut Tensor {
...
pub fn dequantize_tensor_per_channel_affine<'a>(
        qtensor:     &Tensor,
        rtensor:     &mut Tensor,
        scales:      Tensor,
        zero_points: Tensor,
...
pub fn dequantize_tensor_per_channel_float_qparams<'a>(
        qtensor:     &Tensor,
        rtensor:     &mut Tensor,
        scales:      Tensor,
        zero_points: Tensor,
