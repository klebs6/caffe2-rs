...
#[inline] pub fn has_names(tensors: &[Tensor]) -> bool {
...
/**
  | Assumption: A &[Dimname] can have
  | no duplicate full names with the exception
  | of wildcards
  |
  | Unifies two &[Dimname] to produce
...
pub mod namedinference {
    ...
    /**
      ...
      |
      */
    pub fn propagate_names_if_nonempty<'a>(
            result:         &Tensor,
            maybe_names:    &[Dimname],
            validate_names: bool) -> &'a Tensor {
    ...
    pub fn batch_dims(names: &[Dimname]) -> &[Dimname] {
        ...
        todo!();
            /*
              ...
              return &[Dimname](names.begin(), names.end() - 2);
            */
    }

    pub fn feature_dims(names: &[Dimname]) -> &[Dimname] {
        ...
        todo!();
            /*
              ...
              return &[Dimname](names.end() - 2, 2);
            */
    }

    pub fn are_distinct(
        batch_dims:   &[Dimname],
        feature_dims: &[Dimname]) -> bool {
    ...
    pub fn num_batch_dims(names: &[Dimname]) -> i64 {
    ...
    /// -Goethe
    ///
    pub fn compute_cat_outnames(tensors: &[Tensor]) -> Vec<Dimname> {
