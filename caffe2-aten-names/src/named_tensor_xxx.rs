...
pub fn rename_mut<'a>(
    self_: &mut Tensor,
    names: Option<&[Dimname]>) -> &'a mut Tensor {
...
pub fn align_tensors(tensors: &[Tensor]) -> Vec<Tensor> {
