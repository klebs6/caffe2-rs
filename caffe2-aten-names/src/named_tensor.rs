...
pub fn internal_set_names_inplace_with_dimname_list<'a>(
    tensor: &Tensor,
    names:  Option<&[Dimname]>) -> &'a Tensor {
...
pub fn default_names<'a>(len: usize) -> &'a [Dimname] {
    ...
    todo!();
      ...
      return &[Dimname](&all_unnamed.front(), len);
        */
}

pub fn check_unique_names(names: &[Dimname])  {
...
pub fn get_opt_names<'a>(impl_: *const TensorImpl) -> Option<&'a [Dimname]> {
...
pub fn get_names<'a>(impl_: *const TensorImpl) -> &'a [Dimname] {
