...
pub fn binary_cross_entropy_out_cpu<'a>(
        input:      &Tensor,
        target:     &Tensor,
        weight_opt: &Option<Tensor>,
        reduction:  i64,
        loss:       &mut Tensor) -> &'a mut Tensor {
...
pub fn binary_cross_entropy_backward_out_cpu<'a>(
        grad:       &Tensor,
        input:      &Tensor,
        target:     &Tensor,
        weight_opt: &Option<Tensor>,
...
pub fn soft_margin_loss_backward_out<'a>(
        grad_output: &Tensor,
        input:       &Tensor,
        target:      &Tensor,
        reduction:   i64,
...
pub fn smooth_l1_loss_backward_out<'a>(
        grad_output: &Tensor,
        input:       &Tensor,
        target:      &Tensor,
        reduction:   i64,
...
pub fn huber_loss_backward_out<'a>(
        grad_output: &Tensor,
        input:       &Tensor,
        target:      &Tensor,
        reduction:   i64,
...
pub fn mse_loss_backward_out<'a>(
        grad_output: &Tensor,
        input:       &Tensor,
        target:      &Tensor,
        reduction:   i64,
