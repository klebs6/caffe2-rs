...
pub struct DispatchStubImpl {
    ...
    /**
      ...
      | for more details.
      */
    #[cfg(all(target_os = "windows",debug_assertions))]      cpu_dispatch_ptr:  Atomic<*mut c_void>,
    #[cfg(all(target_os = "windows",debug_assertions))]      cuda_dispatch_ptr: *mut c_void,
    #[cfg(all(target_os = "windows",debug_assertions))]      hip_dispatch_ptr:  *mut c_void,

    #[cfg(not(all(target_os = "windows",debug_assertions)))] cpu_dispatch_ptr:  Atomic<*mut c_void>, // default = { nullptr }
    #[cfg(not(all(target_os = "windows",debug_assertions)))] cuda_dispatch_ptr: *mut c_void, // default = nullptr
    #[cfg(not(all(target_os = "windows",debug_assertions)))] hip_dispatch_ptr:  *mut c_void, // default = nullptr
}
...
impl<FnPtr,T> RegisterCUDADispatch<FnPtr,T> {
...
impl<FnPtr,T> RegisterHIPDispatch<FnPtr,T> {
