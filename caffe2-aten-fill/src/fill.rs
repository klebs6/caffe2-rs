...
pub fn fill_diagonal<'a>(
        self_:      &mut Tensor,
        fill_value: &Scalar,
        wrap:       bool) -> &'a mut Tensor {
...
pub fn zero<'a>(self_: &mut Tensor) -> &'a mut Tensor {
...
pub fn zero_meta<'a>(self_: &mut Tensor) -> &'a mut Tensor {
