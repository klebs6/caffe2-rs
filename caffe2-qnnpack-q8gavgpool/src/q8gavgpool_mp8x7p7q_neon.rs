...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/src/q8gavgpool/mp8x7p7q-neon.c]

pub fn pytorch_q8gavgpool_ukernel_mp8x7p7q_neon(
        m:                   usize,
        n:                   usize,
        input:               *const u8,
        input_stride:        usize,
    ...
    todo!();
      ...
      for (m -= 7; m > 7; m -= 7) {
        acc = buffer;
        i0 = (const u8*)((uintptr_t)i0 + input_increment);
        i1 = (const u8*)((uintptr_t)i1 + input_increment);
        i2 = (const u8*)((uintptr_t)i2 + input_increment);
        i3 = (const u8*)((uintptr_t)i3 + input_increment);
        i4 = (const u8*)((uintptr_t)i4 + input_increment);
        i5 = (const u8*)((uintptr_t)i5 + input_increment);
        i6 = (const u8*)((uintptr_t)i6 + input_increment);
