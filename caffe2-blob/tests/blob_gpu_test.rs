...
#[test] 
fn tensor_gpu_death_test_cannot_access_data_when_empty() {
...
#[test] fn tensor_construction_reinitialize_tensor_test() {
...
#[test] 
fn tensor_test_tensor_serialization_multiple_devices() {
