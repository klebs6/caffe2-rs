/*!
  ...
  | Compare results.
  |
  | for quantized Add, the error shouldn't exceed
  | 2 * scale
  */
...
/**
  | LeakyReLU isn't build in xplat, so this
...
#[inline] pub fn setq(dst: *mut Int8TensorCPU, vs: &Vec<f32>)  {
...
#[inline] pub fn biassetq(dst: *mut Int8TensorCPU, vs: &Vec<f32>)  {
...
#[test] fn Int8_Grouped1x1Conv() {
    ...
    /*
      ...
      std::unique_ptr<OperatorStorage> op_ptr(CreateOperator(op, &ws));
