...
pub fn replication_pad2d_backward_out_cpu_template<'a>(
        grad_input:   &mut Tensor,
        grad_output:  &Tensor,
        input:        &Tensor,
        padding_size: &[i32]) -> &'a mut Tensor {
...
pub fn replication_pad3d_backward_out_cpu_template<'a>(
        grad_input:   &mut Tensor,
        grad_output:  &Tensor,
        input:        &Tensor,
        padding_size: &[i32]) -> &'a mut Tensor {
...
pub fn replication_pad2d_backward_out_cpu<'a>(
        grad_output:  &Tensor,
        input:        &Tensor,
        padding_size: &[i32],
...
pub fn replication_pad3d_backward_out_cpu<'a>(
        grad_output:  &Tensor,
        input:        &Tensor,
        padding_size: &[i32],
        grad_input:   &mut Tensor) -> &'a mut Tensor {
