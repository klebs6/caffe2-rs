...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/ConstantPadNd.cpp]
...
pub fn constant_pad_nd(
    ...
    todo!();
        ...
        TORCH_CHECK(l_inp >= (i64)l_pad, "Length of pad should be no more than twice the number of "
        ...
        for (usize i = 0; i < (usize)l_diff; i ++) {
            new_shape.emplace_back(input_sizes[i]);
        }

        for (usize i = 0; i < (usize)l_pad; i++) {
