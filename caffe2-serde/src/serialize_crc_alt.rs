...
/// Slicing-By-16
#[cfg(crc32_use_lookup_table_slicing_by_16)]
pub const MaxSlice: usize = 16;

#[cfg(crc32_use_lookup_table_slicing_by_8)]
pub const MaxSlice: usize = 8;

#[cfg(crc32_use_lookup_table_slicing_by_4)]
pub const MaxSlice: usize = 4;

#[cfg(crc32_use_lookup_table_byte)]
pub const MaxSlice: usize = 1;

//TODO: remove this one and use one of the others
//this will break compilation if we setup the cfg flags above
pub const MaxSlice: usize = 16;

/// compute CRC32 (bitwise algorithm)
#[inline] pub fn crc32_bitwise(
    data:           *const c_void,
    length:         usize,
    previous_crc32: Option<u32>) -> u32 {

    let previous_crc32: u32 = previous_crc32.unwrap_or(0);
...
#[inline] pub fn crc32_1byte_tableless(
    data:           *const c_void,
    length:         usize,
    previous_crc32: Option<u32>) -> u32 {
...
/// compute CRC32 (byte algorithm) without lookup tables
#[inline] pub fn crc32_1byte_tableless2(
    data:           *const c_void,
    length:         usize,
    previous_crc32: Option<u32>) -> u32 {
...
#[cfg(crc32_use_lookup_table_slicing_by_16)]
#[inline] pub fn crc32_16bytes_prefetch(
    data:           *const c_void,
    length:         usize,
    previous_crc32: Option<u32>,
    prefetch_ahead: Option<usize>) -> u32 {

    let previous_crc32: u32 = previous_crc32.unwrap_or(0);
    let prefetch_ahead: usize = prefetch_ahead.unwrap_or(256);
...
/**
  ...
  */
#[inline] pub fn crc32_fast(
    data:           *const c_void,
    length:         usize,
    previous_crc32: u32) -> u32 {
...
/*
  | merge two CRC32 such that result = crc32(dataB,
  | lengthB, crc32(dataA, lengthA))
  |
  */
#[inline] pub fn crc32_combine(
    crca:    u32,
    crcb:    u32,
    lengthb: usize) -> u32 {
...
/**
  ...
  |
  | note: the first number of every second row
  | corresponds to the half-byte
  | look-up table !
  */
pub const Crc32Lookup0: [u32; 256] = [
...
pub const Crc32Lookup1: [u32; 256] = [
...
pub const Crc32Lookup2: [u32; 256] = [
...
pub const Crc32Lookup3: [u32; 256] = [
...
pub const Crc32Lookup4: [u32; 256] = [
...
pub const Crc32Lookup5: [u32; 256] = [
...
pub const Crc32Lookup6: [u32; 256] = [
...
pub const Crc32Lookup7: [u32; 256] = [
...
pub const Crc32Lookup8: [u32; 256] = [
...
pub const Crc32Lookup9: [u32; 256] = [
...
pub const Crc32Lookup10: [u32; 256] = [
...
pub const Crc32Lookup11: [u32; 256] = [
...
pub const Crc32Lookup12: [u32; 256] = [
...
pub const Crc32Lookup13: [u32; 256] = [
...
pub const Crc32Lookup14: [u32; 256] = [
...
pub const Crc32Lookup15: [u32; 256] = [
...
/**
  ...
  */
pub const Crc32Lookup: [[u32; 256]; MaxSlice] = [
    Crc32Lookup0,
    Crc32Lookup1,
    Crc32Lookup2,
    Crc32Lookup3,
