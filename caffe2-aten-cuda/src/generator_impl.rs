...
pub fn get_default_cuda_generator(device_index: DeviceIndex) -> &dyn GeneratorInterface {
...
pub fn create_cuda_generator(device_index: DeviceIndex) -> Box<dyn GeneratorInterface> {
