...
impl IDEEPReshapeOp {
    ...
    pub fn new(operator_def: &OperatorDef, ws: *mut Workspace) -> Self {
        ...
        /*
            ...
            new_shape_(OperatorStorage::GetRepeatedArgument<itensor::dim>("shape"))
        */
    }
    ...
    #[inline] pub fn run_on_device(&mut self) -> bool {
        ...
        if (InputSize() == 2) {
          ...
          auto& shape = OperatorStorage::Input<TensorCPU>(1, CPU);
        ...
        // shape info live on CPU
        TensorCPU* old_shape = OperatorStorage::Output<TensorCPU>(1, CPU);
