...
pub fn special_xlog1py_out_scalar_tensor<'a>(
        self_:  &Scalar,
        other:  &Tensor,
...
pub fn special_xlog1py_out_tensor_scalar<'a>(
        self_:  &Tensor,
        other:  &Scalar,
        result: &mut Tensor) -> &'a mut Tensor {
...
pub fn add_relu_mut_tensor_tensor_with_alpha<'a>(
        self_: &mut Tensor,
        other: &Tensor,
        alpha: &Scalar) -> &'a mut Tensor {
...
pub fn copysign_mut_tensor_scalar<'a>(
        self_: &mut Tensor,
...
/**
  ...
  |
  */
pub fn div_mut_tensor_scalar<'a>(
        self_: &mut Tensor,
        other: &Scalar) -> &'a mut Tensor {
...
pub fn div_mut_tensor_scalar_with_rounding_mode<'a>(
        self_:         &mut Tensor,
        other:         &Scalar,
        rounding_mode: Option<StringView>) -> &'a mut Tensor {
...
pub fn divide_mut_tensor_tensor<'a>(
        self_: &mut Tensor,
...
pub fn divide_mut_tensor_scalar<'a>(
        self_: &mut Tensor,
        other: &Scalar) -> &'a mut Tensor {
...
pub fn divide_out_with_rounding_mode<'a>(
        self_:         &Tensor,
        other:         &Tensor,
...
pub fn divide_mut_tensor_tensor_with_rounding_mode<'a>(
    self_:         &mut Tensor,
    other:         &Tensor,
    rounding_mode: Option<StringView>) -> &'a mut Tensor {
...
pub fn divide_mut_tensor_scalar_with_rounding_mode<'a>(
    self_:         &mut Tensor,
    other:         &Scalar,
    rounding_mode: Option<StringView>) -> &'a mut Tensor {
...
pub fn true_divide_mut<'a>(
    self_:   &mut Tensor,
    divisor: &Tensor) -> &'a mut Tensor {
...
pub fn true_divide_mut_tensor_scalar<'a>(
    self_:   &mut Tensor,
    divisor: &Scalar) -> &'a mut Tensor {
...
pub fn subtract_mut_tensor_scalar_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar,
    alpha: &Scalar) -> &'a mut Tensor {
...
pub fn add_mut_tensor_scalar_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar,
    alpha: &Scalar) -> &'a mut Tensor {
...
pub fn bitwise_and_mut_tensor_tensor<'a>(
    self_: &mut Tensor,
    other: &Tensor) -> &'a mut Tensor {
...
pub fn bitwise_and_out_tensor_scalar<'a>(
    self_:  &Tensor,
    other:  &Scalar,
    result: &mut Tensor) -> &'a mut Tensor {
...
pub fn bitwise_and_mut_tensor_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar) -> &'a mut Tensor {
...
pub fn iand_mut_tensor_tensor<'a>(
    self_: &mut Tensor,
    other: &Tensor) -> &'a mut Tensor {
...
pub fn iand_mut_tensor_scalar<'a>(
        self_: &mut Tensor,
        other: &Scalar) -> &'a mut Tensor {
...
pub fn bitwise_or_tensor_mut<'a>(
        self_: &mut Tensor,
        other: &Tensor) -> &'a mut Tensor {
...
pub fn bitwise_or_out_tensor_scalar<'a>(
        self_:  &Tensor,
        other:  &Scalar,
        result: &mut Tensor) -> &'a mut Tensor {
...
pub fn bitwise_or_mut_tensor_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar) -> &'a mut Tensor {
...
pub fn ior_mut_tensor_tensor<'a>(
        self_: &mut Tensor,
        other: &Tensor) -> &'a mut Tensor {
...
pub fn ior_mut_tensor_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar) -> &'a mut Tensor {
...
pub fn bitwise_xor_out_tensor_tensor<'a>(
        self_:  &Tensor,
        other:  &Tensor,
        result: &mut Tensor) -> &'a mut Tensor {
...
pub fn bitwise_xor_out_tensor_scalar<'a>(
        self_:  &Tensor,
        other:  &Scalar,
        result: &mut Tensor) -> &'a mut Tensor {
...
pub fn bitwise_xor_mut_tensor_scalar<'a>(
        self_: &mut Tensor,
        other: &Scalar) -> &'a mut Tensor {
...
pub fn ixor_mut_tensor_tensor<'a>(
    self_: &mut Tensor,
    other: &Tensor) -> &'a mut Tensor {
...
pub fn ixor_mut_tensor_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar) -> &'a mut Tensor {
...
pub fn ilshift_mut_tensor_tensor<'a>(
    self_: &mut Tensor,
    other: &Tensor) -> &'a mut Tensor {
...
pub fn ilshift_mut_tensor_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar) -> &'a mut Tensor {
...
pub fn irshift_mut_tensor_tensor<'a>(
    self_: &mut Tensor,
    other: &Tensor) -> &'a mut Tensor {
...
pub fn irshift_mut_tensor_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar) -> &'a mut Tensor {
...
pub fn comparison_op_out_mut_with_stub<'a,Stub>(
    result: &mut Tensor,
    self_:  &Tensor,
    other:  &Tensor,
...
/**
  ...
  |
  */
pub fn comparison_op_mut<'a,OutImpl>(
    self_:    &mut Tensor,
    other:    &Tensor,
...
/**
  ...
  |
  */
pub fn comparison_op_out<'a,OutImpl>(
    result:   &mut Tensor,
    self_:    &Tensor,
    other:    &Scalar,
    out_impl: &mut OutImpl) -> &'a mut Tensor {
...
pub fn comparison_op_mut_tensor_scalar<'a,OutImpl>(
    self_:    &mut Tensor,
    other:    &Scalar,
    out_impl: &mut OutImpl) -> &'a mut Tensor {
...
pub fn less_mut_tensor_tensor<'a>(
    self_: &mut Tensor,
    other: &Tensor) -> &'a mut Tensor {
...
pub fn less_out_tensor_scalar<'a>(
    self_:  &Tensor,
    other:  &Scalar,
    result: &mut Tensor) -> &'a mut Tensor {
...
pub fn less_mut_tensor_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar) -> &'a mut Tensor {
...
/**
  ...
  |
  */
pub fn less_equal_out_tensor_tensor<'a>(
    self_:  &Tensor,
    other:  &Tensor,
    result: &mut Tensor) -> &'a mut Tensor {
...
pub fn less_equal_mut_tensor_tensor<'a>(
    self_: &mut Tensor,
    other: &Tensor) -> &'a mut Tensor {
...
pub fn less_equal_out_tensor_scalar<'a>(
    self_:  &Tensor,
    other:  &Scalar,
    result: &mut Tensor) -> &'a mut Tensor {
...
pub fn less_equal_mut_tensor_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar) -> &'a mut Tensor {
...
/**
  ...
  |
  */
pub fn greater_out_tensor_tensor<'a>(
        self_:  &Tensor,
        other:  &Tensor,
        result: &mut Tensor) -> &'a mut Tensor {
...
pub fn greater_mut_tensor_tensor<'a>(
    self_: &mut Tensor,
    other: &Tensor) -> &'a mut Tensor {
...
pub fn greater_out_tensor_scalar<'a>(
    self_:  &Tensor,
    other:  &Scalar,
    result: &mut Tensor) -> &'a mut Tensor {
...
pub fn greater_mut_tensor_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar) -> &'a mut Tensor {
...
/**
  ...
  |
  */
pub fn greater_equal_out_tensor_tensor<'a>(
        self_:  &Tensor,
        other:  &Tensor,
        result: &mut Tensor) -> &'a mut Tensor {
...
pub fn greater_equal_mut_tensor_tensor<'a>(
    self_: &mut Tensor,
    other: &Tensor) -> &'a mut Tensor {
...
pub fn greater_equal_out_tensor_scalar<'a>(
    self_:  &Tensor,
    other:  &Scalar,
    result: &mut Tensor) -> &'a mut Tensor {
...
pub fn greater_equal_mut_tensor_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar) -> &'a mut Tensor {
...
/**
  ...
  |
  */
pub fn not_equal_out_tensor_tensor<'a>(
        self_:  &Tensor,
        other:  &Tensor,
        result: &mut Tensor) -> &'a mut Tensor {
...
pub fn not_equal_mut_tensor_tensor<'a>(
    self_: &mut Tensor,
    other: &Tensor) -> &'a mut Tensor {
...
pub fn not_equal_out_tensor_scalar<'a>(
    self_:  &Tensor,
    other:  &Scalar,
    result: &mut Tensor) -> &'a mut Tensor {
...
pub fn not_equal_mut_tensor_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar) -> &'a mut Tensor {
...
pub fn logical_and_out_tensor_tensor<'a>(
    self_:  &Tensor,
    other:  &Tensor,
    result: &mut Tensor) -> &'a mut Tensor {
...
pub fn logical_and_mut_tensor_tensor<'a>(
    self_: &mut Tensor,
    other: &Tensor) -> &'a mut Tensor {
...
pub fn logical_and_mut_tensor_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar) -> &'a mut Tensor {
...
pub fn logical_or_mut_tensor_tensor<'a>(
    self_: &mut Tensor,
    other: &Tensor) -> &'a mut Tensor {
...
pub fn logical_or_out_mut_tensor_tensor<'a>(
    result: &mut Tensor,
    self_:  &Tensor,
    other:  &Scalar) -> &'a mut Tensor {
...
pub fn logical_or_mut_tensor_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar) -> &'a mut Tensor {
...
pub fn logical_xor_out_tensor_tensor<'a>(
    self_:  &Tensor,
    other:  &Tensor,
    result: &mut Tensor) -> &'a mut Tensor {
...
pub fn logical_xor_mut_tensor_tensor<'a>(
    self_: &mut Tensor,
    other: &Tensor) -> &'a mut Tensor {
...
pub fn logical_xor_out_mut_tensor_tensor<'a>(
    result: &mut Tensor,
    self_:  &Tensor,
    other:  &Scalar) -> &'a mut Tensor {
...
pub fn logical_xor_mut_tensor_scalar<'a>(
        self_: &mut Tensor,
        other: &Scalar) -> &'a mut Tensor {
...
pub fn fmod_out_tensor_scalar<'a>(
    self_:  &Tensor,
    other:  &Scalar,
    result: &mut Tensor) -> &'a mut Tensor {
...
pub fn fmod_mut_tensor_tensor<'a>(
    self_: &mut Tensor,
    other: &Tensor) -> &'a mut Tensor {
...
pub fn fmod_mut_tensor_scalar<'a>(
    self_: &mut Tensor,
    other: &Scalar) -> &'a mut Tensor {
...
pub fn ldexp_out_tensor_tensor<'a>(
        self_:  &Tensor,
        other:  &Tensor,
        result: &mut Tensor) -> &'a mut Tensor {
...
pub fn ldexp_mut_tensor_tensor<'a>(
        self_: &mut Tensor,
        other: &Tensor) -> &'a mut Tensor {
...
pub fn xlogy_out_scalar_tensor<'a>(
        self_:  &Scalar,
        other:  &Tensor,
        result: &mut Tensor) -> &'a mut Tensor {
...
pub fn xlogy_out_tensor_scalar<'a>(
        self_:  &Tensor,
        other:  &Scalar,
        result: &mut Tensor) -> &'a mut Tensor {
...
pub fn xlogy_mut_tensor_tensor<'a>(
        x: &mut Tensor,
        y: &Tensor) -> &'a mut Tensor {
...
pub fn xlogy_mut_tensor_scalar<'a>(
        x: &mut Tensor,
        y: &Scalar) -> &'a mut Tensor {
