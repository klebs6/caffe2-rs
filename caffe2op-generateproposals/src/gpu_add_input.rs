...
#[inline] pub fn gpu_add_lin_spaced_input(
    shape:    &Vec<i64>,
    min_val:  f32,
    max_val:  f32,
    name:     &String,
...
#[inline] pub fn gpu_add_const_input<Context>(
    shape:       &Vec<i64>,
    value:       f32,
    name:        &String,
    context:     *mut Context,
...
#[inline] pub fn gpu_add_input<Context>(
    shape:  &Vec<i64>,
    values: &Vec<f32>,
    name:   &String,
...
#[inline] pub fn gpu_add_input_cpu_context(
    shape:  &Vec<i64>,
    values: &Vec<f32>,
    name:   &String,
    ws:     *mut Workspace)  
...
#[inline] pub fn gpu_add_input_cudacontext(
    shape:    &Vec<i64>,
    values:   &Vec<f32>,
    name:     &String,
    ws:       *mut Workspace)  
