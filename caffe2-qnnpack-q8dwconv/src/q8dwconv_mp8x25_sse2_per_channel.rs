...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/src/q8dwconv/mp8x25-sse2-per-channel.c]


pub fn pytorch_q8dwconv_ukernel_mp8x25_per_channel_sse2(
        channels:            usize,
        output_width:        usize,
    ...
    todo!();
      ...
      do {
        ...
        {
          const u8* i00 = input[0];
          const u8* i01 = input[1];
          const u8* i02 = input[2];
          const u8* i10 = input[3];
          const u8* i11 = input[4];
          const u8* i12 = input[5];
          const u8* i20 = input[6];
          const u8* i21 = input[7];
          const u8* i22 = input[8];
          const u8* i23 = input[9];
          ...
          if (c != 0) {
            const usize i_predecrement = 8 - c;
        ...
        {
          const u8* i00 = input[10];
          const u8* i01 = input[11];
          const u8* i02 = input[12];
          const u8* i10 = input[13];
          const u8* i11 = input[14];
          const u8* i12 = input[15];
          const u8* i20 = input[16];
          const u8* i21 = input[17];
          const u8* i22 = input[18];
          const u8* i23 = input[19];
          outacc = outacc32;
        ...
        {
          const u8* i00 = input[20];
          const u8* i01 = input[21];
          const u8* i02 = input[22];
          const u8* i10 = input[23];
          const u8* i11 = input[24];
          input = (const u8**)((uintptr_t)input + input_stride);
          outacc = outacc32;
          usize c = channels;
          for (; c >= 8; c -= 8) {
            const __m128i vi00 = _mm_loadl_epi64((const __m128i*)i00);
