...
pub fn kthvalue_out_impl_cpu<'a>(
    values:  &mut Tensor,
    indices: &mut Tensor,
    self_:   &Tensor,
    k:       i64,
...
/**
  ...
  |
  */
pub fn median_with_indices_impl<'a>(
        values:     &mut Tensor,
        indices:    &mut Tensor,
        self_:      &Tensor,
        dim:        i64,
        keepdim:    bool,
        ignore_nan: bool) -> (&'a mut Tensor,&'a mut Tensor) {
