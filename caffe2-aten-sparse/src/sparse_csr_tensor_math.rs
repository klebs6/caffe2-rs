...
pub fn addmm_out_sparse_csr_dense_cpu<'a>(
        self_:  &Tensor,
...
pub fn add_out_dense_sparse_csr_cpu<'a>(
        out:   &mut Tensor,
        dense: &Tensor,
        src:   &SparseCsrTensor,
        alpha: &Scalar) -> &'a mut Tensor {
...
pub fn add_out_sparse_csr_cpu<'a>(
        self_: &Tensor,
        other: &SparseCsrTensor,
        alpha: &Scalar,
        out:   &mut SparseCsrTensor) -> &'a mut Tensor {
