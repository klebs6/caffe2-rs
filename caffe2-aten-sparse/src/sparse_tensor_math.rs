...
pub fn floor_divide_sparse_b<'a>(
        self_: &mut Tensor,
        value: &Tensor) -> &'a mut Tensor {
...
pub fn sub_out_sparse<'a>(
        self_: &Tensor,
        other: &Tensor,
        alpha: &Scalar,
        r:     &mut Tensor) -> &'a mut Tensor {
...
pub fn add_out_dense_sparse_cpu<'a>(
        r:      &mut Tensor,
        dense:  &Tensor,
        sparse: &SparseTensor,
...
pub fn s_addmm_out_sparse_dense_cpu<'a>(
        r:      &mut Tensor,
        t:      &Tensor,
        sparse: &SparseTensor,
        dense:  &Tensor,
...
pub fn addmm_out_sparse_dense_cpu<'a>(
        self_:  &Tensor,
        mat1:   &SparseTensor,
        mat2:   &Tensor,
        beta:   &Scalar,
...
pub fn s_addmm_sparse_dense_cpu_b<'a>(
        t:      &mut Tensor,
        sparse: &SparseTensor,
        dense:  &Tensor,
        beta:   &Scalar,
...
///
pub fn sspaddmm_out_only_sparse<'a>(
        self_:  &Tensor,
        mat1:   &Tensor,
        mat2:   &Tensor,
        beta:   &Scalar,
...
// }
pub fn conj_physical_out_sparse<'a>(
        input:  &Tensor,
        result: &mut Tensor) -> &'a mut Tensor {
