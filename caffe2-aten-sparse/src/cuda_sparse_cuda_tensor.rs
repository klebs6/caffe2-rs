...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/sparse/cuda/SparseCUDATensor.cpp]

pub fn sparse_mask_out_cuda(
    r:    &mut SparseTensor,
    t:    &Tensor,
    ...
    todo!();
      ...
      TORCH_CHECK(check_device({r, t, mask}),
      ...
      alias_into_sparse(r, mask_indices.clone(MemoryFormat::Contiguous), r_values);
