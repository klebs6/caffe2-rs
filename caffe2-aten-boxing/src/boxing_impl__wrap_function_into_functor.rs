...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/core/boxing/impl/WrapFunctionIntoFunctor.h]
...
/**
  | WrapFunctionIntoFunctor: Wraps a compile time
  | function pointer into a kernel functor.
  |
  | Since it is a compile time function pointer,
  | many compilers can inline it into the wrapper
  | and you don't get any performance overhead for
  | wrapping.
  */
lazy_static!{
    /*
