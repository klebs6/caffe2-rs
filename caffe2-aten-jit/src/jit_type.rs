...
impl<T> PartialEq<VaryingShape> for VaryingShape<T> {
...
impl<T> Index<usize> for VaryingShape<T> {
...
impl GetTypePtr for complex<double> {
...
impl GetTypePtr for ScalarType {
...
impl GetTypePtr for MemoryFormat {
...
impl GetTypePtr for dyn GeneratorInterface {
...
impl GetTypePtr for string_view {
...
impl GetTypePtr for unordered_map<K, V> {
...
impl GetTypePtr for optional<T> {
...
impl GetTypePtr for tuple<Contained> {
