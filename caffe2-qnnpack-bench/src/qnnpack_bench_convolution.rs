...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/bench/convolution.cc]

pub fn convolution_q8(
    ...
    per_channel: Option<bool>) 
{
    ...
    todo!();
      ...
      const usize kernelHeight = state.range(3);
      const usize kernelWidth = state.range(4);
      const usize subsampling = state.range(5);
      const usize dilation = state.range(6);
      const usize groups = state.range(7);
      const usize groupInputChannels = state.range(8);
      const usize groupOutputChannels = state.range(9);
      ...
      const usize outputPixelStride = groups * groupOutputChannels;
      const usize inputPixelStride = groups * groupInputChannels;
      const usize effectiveKernelHeight = (kernelHeight - 1) * dilation + 1;
      const usize effectiveKernelWidth = (kernelWidth - 1) * dilation + 1;
      const usize paddingLeft = effectiveKernelWidth / 2;
      const usize paddingTop = effectiveKernelHeight / 2;
      const usize paddingRight = effectiveKernelWidth - 1 - paddingLeft;
      const usize paddingBottom = effectiveKernelHeight - 1 - paddingTop;
      ...
      vector<u8> kernel_zero_points(num_zero_points_padded, 127);
      vector<float> requantization_scale(
      ...
      state.SetItemsProcessed(
          u64(state.iterations()) * 2 * batchSize * outputHeight *
...
/**
  ...
  |
  */
pub fn shuffle_netv2x05(b: *mut Benchmark)  {
...
/**
  ...
  |
  */
pub fn shuffle_netv2x10(b: *mut Benchmark)  {
...
/**
  ...
  |
  */
pub fn shuffle_netv2x15(b: *mut Benchmark)  {
...
/**
  ...
  |
  */
pub fn shuffle_netv2x20(b: *mut Benchmark)  {
...
pub fn mobile_netv1(b: *mut Benchmark)  {
...
pub fn mobile_netv2(b: *mut Benchmark)  {
...
pub fn res_net18(b: *mut Benchmark)  {
...
pub fn res_net50(b: *mut Benchmark)  {
...
pub fn dw_conv3x3(b: *mut Benchmark)  {
...
pub fn dw_conv3x3d2(b: *mut Benchmark)  {
...
pub fn dw_conv5x5(b: *mut Benchmark)  {
