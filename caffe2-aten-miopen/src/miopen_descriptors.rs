...
#[inline] pub fn data_size(data_type: MiOpenDataType) -> i32 {
...
impl RNNDescriptor {
    ...
    pub fn set(&mut self, 
        hidden_size: i64,
        num_layers:  i64,
        input_mode:  MiOpenRNNInputMode,
        direction:   MiOpenRNNDirectionMode,
        rnn_mode:    MiOpenRNNMode,
        bias_mode:   MiOpenRNNBiasMode,
        algorithm:   MiOpenRNNAlgo,
        datatype:    MiOpenDataType)  {
...
#[inline] pub fn get_data_type(t: &Tensor) -> MiOpenDataType {
...
pub fn miopen_type_to_string(dtype: MiOpenDataType) -> String {
