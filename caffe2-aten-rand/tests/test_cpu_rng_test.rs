...
mod aten_cpu_static_dispatch {
    ...
    pub fn normal_tensor_float_out<'a>(
            mean:   &Tensor,
            std:    f64,
    ...
    pub fn normal_float_tensor_out<'a>(
            mean:   f64,
            std:    &Tensor,
            gen:    Option<Generator>,
            output: &mut Tensor) -> &'a mut Tensor {
    ...
    pub fn normal_tensor_tensor_out<'a>(
            mean:   &Tensor,
            std:    &Tensor,
            gen:    Option<Generator>,
            output: &mut Tensor) -> &'a mut Tensor {
