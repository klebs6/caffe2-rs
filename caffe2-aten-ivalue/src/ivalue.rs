...
impl IValue {
    ...
    pub fn to_tensor<'a>(&mut self) -> Tensor {
    ...
    pub fn to_tensor<'a>(&mut self) -> &'a mut Tensor {
    ...
    pub fn to_tensor<'a>(&mut self) -> &'a Tensor {
    ...
    pub fn new<T>(custom_class: IntrusivePtr<T>) -> Self {
    ...
    pub fn new(g: dyn GeneratorInterface) -> Self {
...
pub fn get_custom_class_type<'a,T>() -> &'a ClassTypePtr {
...
/**
  ...
  |
  */
pub fn print_maybe_annotated_list<'a>(
    out:       &mut std::io::BufWriter,
    the_list:  &IValue,
    formatter: IValueFormatter
...
/// dict
///
pub fn print_maybe_annotated_dict<'a>(
    out:       &mut std::io::BufWriter,
    the_dict:  &IValue,
    formatter: IValueFormatter
...
pub fn get_custom_class_type_map<'a>() -> &'a mut FlatHashMap<TypeIndex,ClassTypePtr> {
...
pub fn get_class_converter<'a>() -> &'a mut HashMap<String,fn(_0: *mut void) -> *mut PyObject> {
