...
impl IValue {
    ...
    #[inline] pub fn to_tensor<'a>(&mut self) -> Tensor {
    ...
    #[inline] pub fn to_tensor<'a>(&mut self) -> &'a mut Tensor {
    ...
    #[inline] pub fn to_generator(&mut self) -> dyn GeneratorInterface {
...
impl IValue {
    ...
    #[inline] pub fn to_tensor_list(&mut self) -> List<Tensor> {
        ...
        todo!();
        /*
            AT_ASSERT(isTensorList(), "Expected &[Tensor] but got ", tagKind());
    ...
    pub fn new<T,const N: usize>(v: [T;N]) -> Self {
