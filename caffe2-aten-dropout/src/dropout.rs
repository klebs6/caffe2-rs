...
/**
  ...
  |
  */
pub fn multiply_a<'a,const inplace: bool>(
        input: &mut Tensor,
        noise: &Tensor) -> &'a mut Tensor {
...
pub fn feature_alpha_dropout_b<'a>(
        input: &mut Tensor,
        p:     f64,
        train: bool) -> &'a mut Tensor {
