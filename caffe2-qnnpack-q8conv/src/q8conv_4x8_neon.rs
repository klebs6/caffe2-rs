...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/src/q8conv/4x8-neon.c]

pub fn pytorch_q8conv_ukernel_4x8_neon(
    mr:                   usize,
    nr:                   usize,
    kc:                   usize,
    ks:                   usize,
    ...
    todo!();
       ...
       * - Large i32 values can't be exactly represented as FP32. The
