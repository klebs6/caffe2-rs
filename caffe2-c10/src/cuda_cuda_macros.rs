/*!
  | See c10/macros/Export.h for a detailed
  | explanation of what the function of these
  | macros are.
  |
  | We need one set of macros for every separate
  | library we build.
  */

crate::ix!();

//-------------------------------------------[.cpp/pytorch/c10/cuda/CUDAMacros.h]
...
/**
  ...
  |
  */
pub const C10_COMPILE_TIME_MAX_GPUS: usize = 16;
