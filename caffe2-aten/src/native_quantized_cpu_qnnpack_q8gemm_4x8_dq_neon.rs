...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/src/q8gemm/4x8-dq-neon.c]

pub fn pytorch_q8gemm_dq_ukernel_4x8_neon(
        mr:                   usize,
        nr:                   usize,
        k:                    usize,
        a:                    *const u8,
    ...
    todo!();
      ...
      const uint8x8_t va_zero_point =
          vld1_dup_u8((const u8*)&quantization_params->input_zero_point);
      ...
      const uint8x8_t vb_zero_point =
          vld1_u8((const u8*)&quantization_params->kernel_zero_points
