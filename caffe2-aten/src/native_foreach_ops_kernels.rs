...
#[macro_export] macro_rules! foreach_binary_op_scalar {
    ($OP:ident) => {
        ...
        vector<Tensor> foreach_tensor_##OP##_scalar_kernel_slow(TensorList tensors, const Scalar& scalar) {         
          check_foreach_api_restrictions(tensors);                                                                
...
#[macro_export] macro_rules! foreach_binary_op_scalarlist {
    ($OP:ident) => {
        ...
        void foreach_tensor_##OP##_scalarlist_kernel_slow_(TensorList tensors, ArrayRef<Scalar> scalars) {                  
        ...
        vector<Tensor> foreach_tensor_##OP##_scalarlist_kernel_slow(TensorList tensors, ArrayRef<Scalar> scalars) {    
          check_foreach_api_restrictions(tensors, scalars);                                                                     
          vector<Tensor> result;                                                                                           
          result.reserve(tensors.size());                                                                                       
          for (const auto i : irange(tensors.size())) {                                                                    
...
#[macro_export] macro_rules! foreach_binary_op_list {
    ($OP:ident) => {
        ...
        vector<Tensor> foreach_tensor_##OP##_list_kernel_slow(TensorList tensors1, TensorList tensors2) {    
...
#[macro_export] macro_rules! foreach_binary_op_list_alpha {
    ($OP:ident) => {
        ...
        vector<Tensor> foreach_tensor_##OP##_list_kernel_slow(TensorList tensors1, TensorList tensors2, const Scalar& alpha) {    
          check_foreach_api_restrictions(tensors1, tensors2);                                                                   
...
#[macro_export] macro_rules! foreach_unary_op {
    ($OP:ident) => {
        ...
        vector<Tensor> foreach_tensor_##OP##_slow(TensorList tensors) {       
          check_foreach_api_restrictions(tensors);                                 
...
#[macro_export] macro_rules! foreach_pointwise_op_scalar {
    ($OP:ident) => {
        ...
        vector<Tensor> foreach_tensor_##OP##_scalar_slow(TensorList input, TensorList tensors1, TensorList tensors2, const Scalar& scalar) {   
...
#[macro_export] macro_rules! foreach_pointwise_op_scalarlist {
    ($OP:ident) => {
        ...
        vector<Tensor> foreach_tensor_##OP##_scalarlist_slow(TensorList input, TensorList tensors1, TensorList tensors2, ArrayRef<Scalar> scalars) {   
        ...
        void foreach_tensor_##OP##_scalarlist_slow_(TensorList input, TensorList tensors1, TensorList tensors2, ArrayRef<Scalar> scalars) {                 
          check_foreach_api_restrictions(input, tensors1, tensors2, scalars);                                                                                   
...
#[macro_export] macro_rules! foreach_maximum_minimum_op {
    ($NAME:ident) => {
        ...
        vector<Tensor> foreach_tensor_##NAME##_slow(TensorList tensors1, TensorList tensors2) { 
          check_foreach_api_restrictions(tensors1, tensors2);                                        
...
pub fn foreach_tensor_zero_slow(tensors: TensorList)  {
