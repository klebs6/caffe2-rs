...
mod not_mkldnn {
    ...
    pub fn mkldnn_sigmoid(self_: &Tensor) -> Tensor {
    ...
    pub fn mkldnn_sigmoid_mut(self_: &mut Tensor) -> &mut Tensor {
    ...
    pub fn mkldnn_tanh(self_: &Tensor) -> Tensor {
    ...
    pub fn mkldnn_tanh_mut(self_: &mut Tensor) -> &mut Tensor {
