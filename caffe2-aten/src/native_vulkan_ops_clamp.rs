...
pub fn activation_mut(
    self_:             &mut Tensor,
    shader_descriptor: &ShaderDescriptor) -> &mut Tensor {
...
pub fn hardsigmoid(self_: &Tensor) -> Tensor {
...
pub fn hardsigmoid_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn sigmoid_mut(self_: &mut Tensor) -> &mut Tensor {
