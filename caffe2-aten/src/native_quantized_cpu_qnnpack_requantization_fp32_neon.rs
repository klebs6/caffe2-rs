...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/src/requantization/fp32-neon.c]

pub fn pytorch_qnnp_requantize_fp32_neon(
    n:          Size,
    input:      *const i32,
    scale:      f32,
    zero_point: u8,
    ...
    todo!();
      ...
      const int32x4_t vimagic =
          vdupq_n_s32(INT32_C(0x4B400000) - (i32)(u32)zero_point);
    #endif
      for (; n != 0; n -= 16) {
