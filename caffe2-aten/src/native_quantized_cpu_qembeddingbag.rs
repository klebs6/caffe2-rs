...
/**
  ...
  |
  */
pub fn embedding_lookup_fallback_impl<IndexType, OffsetType, const BIT_RATE: i32, const NUM_ELEM_PER_BYTE: i32>(
        weight:                     &Tensor,
        indices:                    &Tensor,
        offsets:                    &Tensor,
...
pub fn embedding_bag_4bit_impl<IndexType, OffsetType>(
        output:                     &mut Tensor,
        weight:                     &Tensor,
        indices:                    &Tensor,
        offsets:                    &Tensor,
        ...
        per_sample_weights:         &Option<Tensor>,
        compressed_indices_mapping: &Option<Tensor>,
        include_last_offset:        bool) -> &mut Tensor {
...
pub fn embedding_bag_byte_impl<IndexType, OffsetType>(
        output:                     &mut Tensor,
        weight:                     &Tensor,
        indices:                    &Tensor,
        offsets:                    &Tensor,
        ...
        compressed_indices_mapping: &Option<Tensor>,
        include_last_offset:        bool,
        is_embedding_op:            bool) -> &mut Tensor {
...
pub fn embedding_bag_byte_helper(
        output:                     &mut Tensor,
        weight:                     &Tensor,
        indices:                    &Tensor,
...
pub fn embedding_bag_4bit_helper(
        output:                     &mut Tensor,
        weight:                     &Tensor,
        indices:                    &Tensor,
        offsets_in:                 &Option<Tensor>,
...
pub fn embedding_bag_byte_rowwise_offsets_out(
        output:                     &mut Tensor,
        weight:                     &Tensor,
        indices:                    &Tensor,
        offsets_in:                 &Option<Tensor>,
...
pub fn embedding_bag_4bit_rowwise_offsets_out(
        output:                     &mut Tensor,
        weight:                     &Tensor,
        indices:                    &Tensor,
        offsets_in:                 &Option<Tensor>,
