...
#[cfg(USE_CUSOLVER)]
pub fn linalg_inv_out_helper_cuda_lib(
        result:      &mut Tensor,
        infos_getrf: &mut Tensor,
        infos_getrs: &mut Tensor) -> &mut Tensor {
...
#[cfg(USE_CUSOLVER)]
pub fn cholesky_inverse_kernel_impl_cusolver(
        result: &mut Tensor,
        infos:  &mut Tensor,
...
#[cfg(USE_CUSOLVER)]
pub fn orgqr_helper_cusolver(
        result: &mut Tensor,
        tau:    &Tensor) -> &mut Tensor {
