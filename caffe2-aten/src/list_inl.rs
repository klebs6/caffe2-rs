...
impl List {
    ...
    pub fn get<T>(&self, pos: SizeType) -> List<T>::value_type {
...
impl IndexMut<SizeType> for List {
...
impl List {
    ...
    pub fn extract(&self, pos: SizeType) -> List<T>::value_type {
