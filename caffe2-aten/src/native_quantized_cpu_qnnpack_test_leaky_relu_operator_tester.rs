...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/test/leaky-relu-operator-tester.h]

pub struct LeakyReLUOperatorTester {
    batch_size:        usize, // default = { 1 }
    channels:          usize, // default = { 1 }
    input_stride:      usize, // default = { 0 }
    output_stride:     usize, // default = { 0 }
    negative_slope:    f32, // default = { 0.5f }
    output_scale:      f32, // default = { 0.75f }
    output_zero_point: u8, // default = { 133 }
    input_scale:       f32, // default = { 1.25f }
...
impl LeakyReLUOperatorTester {

    #[inline] pub fn channels(&mut self, channels: usize) -> &mut LeakyReLUOperatorTester {
    ...
    #[inline] pub fn input_stride(&mut self, input_stride: usize) -> &mut LeakyReLUOperatorTester {
    ...
    #[inline] pub fn output_stride(&mut self, output_stride: usize) -> &mut LeakyReLUOperatorTester {
    ...
    #[inline] pub fn batch_size(&mut self, batch_size: usize) -> &mut LeakyReLUOperatorTester {
    ...
    #[inline] pub fn negative_slope(&mut self, negative_slope: f32) -> &mut LeakyReLUOperatorTester {
    ...
    #[inline] pub fn negative_slope(&self) -> f32 {
    ...
    #[inline] pub fn input_scale(&mut self, input_scale: f32) -> &mut LeakyReLUOperatorTester {
    ...
    #[inline] pub fn input_zero_point(&mut self, input_zero_point: u8) -> &mut LeakyReLUOperatorTester {
    ...
    #[inline] pub fn output_scale(&mut self, output_scale: f32) -> &mut LeakyReLUOperatorTester {
    ...
    #[inline] pub fn output_zero_point(&mut self, output_zero_point: u8) -> &mut LeakyReLUOperatorTester {
    ...
    #[inline] pub fn qmin(&mut self, qmin: u8) -> &mut LeakyReLUOperatorTester {
    ...
    #[inline] pub fn qmax(&mut self, qmax: u8) -> &mut LeakyReLUOperatorTester {
    ...
    #[inline] pub fn iterations(&mut self, iterations: usize) -> &mut LeakyReLUOperatorTester {
        ...
        for (usize iteration = 0; iteration < iterations(); iteration++) {
          ...
          for (usize i = 0; i < batchSize(); i++) {
            for (usize c = 0; c < channels(); c++) {
              ...
              outputRef[i * channels() + c] = y + float(i32(outputZeroPoint()));
            }
          }
