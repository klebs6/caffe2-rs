...
#[inline] pub fn unary_op_impl_out<Stub>(
        result: &mut Tensor,
        self_:  &Tensor,
...
#[inline] pub fn unary_op_impl_float_out<Stub, Args>(
        result: &mut Tensor,
        self_:  &Tensor,
        stub:   &mut Stub,
        args:   Args) -> &mut Tensor {
...
/**
  ...
  |
  */
#[inline] pub fn unary_op_impl_with_complex_to_float_out<Stub>(
    result:                    &mut Tensor,
    self_:                     &Tensor,
    stub:                      &mut Stub,
    promotes_integer_to_float: bool) -> &mut Tensor {
...
#[inline] pub fn unary_op_impl_mut<OutImpl>(
    self_:    &mut Tensor,
...
pub fn arccos_a(self_: &Tensor) -> Tensor {
...
pub fn arccos_b(self_: &mut Tensor) -> &mut Tensor {
...
pub fn rad2deg_a(self_: &Tensor) -> Tensor {
...
pub fn rad2deg_b(self_: &mut Tensor) -> &mut Tensor {
...
pub fn deg2rad_a(self_: &Tensor) -> Tensor {
...
pub fn deg2rad_b(self_: &mut Tensor) -> &mut Tensor {
...
pub fn arcsin(self_: &Tensor) -> Tensor {
...
pub fn arcsin_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn arctan(self_: &Tensor) -> Tensor {
...
pub fn arctan_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn abs_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn absolute(self_: &Tensor) -> Tensor {
...
pub fn absolute_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn conj_physical_b(self_: &Tensor) -> Tensor {
...
pub fn conj_physical_c(self_: &mut Tensor) -> &mut Tensor {
...
pub fn arccosh(self_: &Tensor) -> Tensor {
...
pub fn arccosh_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn arcsinh(self_: &Tensor) -> Tensor {
...
pub fn arcsinh_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn arctanh(self_: &Tensor) -> Tensor {
...
pub fn arctanh_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn square(self_: &Tensor) -> Tensor {
...
pub fn square_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn nan_to_num_mut(
    self_:   &mut Tensor,
    nan:     Option<f64>,
    pos_inf: Option<f64>,
    neg_inf: Option<f64>) -> &mut Tensor {
...
pub fn fix(self_: &Tensor) -> Tensor {
...
pub fn fix_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn negative(self_: &Tensor) -> Tensor {
...
pub fn negative_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn logical_not(self_: &Tensor) -> Tensor {
...
pub fn logical_not_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn frexp_out(
        self_:    &Tensor,
        mantissa: &mut Tensor,
        exponent: &mut Tensor) -> (&mut Tensor,&mut Tensor) {
