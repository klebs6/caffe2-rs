...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/test/tanh-operator-tester.h]

pub struct TanHOperatorTester {
...
impl TanHOperatorTester {

    
    #[inline] pub fn channels(&mut self, channels: usize) -> &mut TanHOperatorTester {
    ...
    #[inline] pub fn input_stride(&mut self, input_stride: usize) -> &mut TanHOperatorTester {
    ...
    #[inline] pub fn output_stride(&mut self, output_stride: usize) -> &mut TanHOperatorTester {
    ...
    #[inline] pub fn batch_size(&mut self, batch_size: usize) -> &mut TanHOperatorTester {
    ...
    #[inline] pub fn input_scale(&mut self, input_scale: f32) -> &mut TanHOperatorTester {
    ...
    #[inline] pub fn input_zero_point(&mut self, input_zero_point: u8) -> &mut TanHOperatorTester {
    ...
    #[inline] pub fn qmin(&mut self, qmin: u8) -> &mut TanHOperatorTester {
    ...
    #[inline] pub fn qmax(&mut self, qmax: u8) -> &mut TanHOperatorTester {
    ...
    #[inline] pub fn iterations(&mut self, iterations: usize) -> &mut TanHOperatorTester {
