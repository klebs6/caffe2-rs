...
pub fn hardswish_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn relu(self_: &Tensor) -> Tensor {
...
pub fn relu_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn relu6(self_: &Tensor) -> Tensor {
...
pub fn selu_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn relu6_mut(self_: &mut Tensor) -> &mut Tensor {
...
pub fn rrelu_with_noise_out_cpu(
        self_:     &Tensor,
        noise:     &Tensor,
        lower:     &Scalar,
        upper:     &Scalar,
...
pub fn rrelu_with_noise_cpu_mut(
        self_:     &mut Tensor,
        noise:     &Tensor,
        lower:     &Scalar,
        upper:     &Scalar,
...
pub fn log_sigmoid_forward_out_cpu(
        input:  &Tensor,
        result: &mut Tensor,
...
pub fn log_sigmoid_backward_out_cpu(
    grad_output: &Tensor,
    input:       &Tensor,
    buffer:      &Tensor,
    grad_input:  &mut Tensor) -> &mut Tensor {
