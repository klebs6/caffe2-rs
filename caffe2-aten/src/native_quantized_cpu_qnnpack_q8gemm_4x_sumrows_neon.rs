...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/src/q8gemm/4x-sumrows-neon.c]
    ...
    todo!();
      ...
      if (k >= 4) {
        vacc0x0123 = vaddw_u16(
            ...
            vget_low_u16(vmovl_u8(vreinterpret_u8_u32(
                vld1_dup_u32(__builtin_assume_aligned((const u32*)a0, 1))))));
        a0 += 4;
        vacc1x0123 = vaddw_u16(
            vacc1x0123,
            vget_low_u16(vmovl_u8(vreinterpret_u8_u32(
                vld1_dup_u32(__builtin_assume_aligned((const u32*)a1, 1))))));
        a1 += 4;
        vacc2x0123 = vaddw_u16(
            vacc2x0123,
            vget_low_u16(vmovl_u8(vreinterpret_u8_u32(
                vld1_dup_u32(__builtin_assume_aligned((const u32*)a2, 1))))));
        a2 += 4;
        vacc3x0123 = vaddw_u16(
            vacc3x0123,
            vget_low_u16(vmovl_u8(vreinterpret_u8_u32(
                vld1_dup_u32(__builtin_assume_aligned((const u32*)a3, 1))))));
        a3 += 4;
        k -= 4;
      }
      ...
      if (k >= 2) {
        const uint8x8_t va0x01010101 = vreinterpret_u8_u16(
            vld1_dup_u16(__builtin_assume_aligned((const u16*)a0, 1)));
        a0 += 2;
        const uint8x8_t va1x01010101 = vreinterpret_u8_u16(
            vld1_dup_u16(__builtin_assume_aligned((const u16*)a1, 1)));
        a1 += 2;
        const uint8x8_t va2x01010101 = vreinterpret_u8_u16(
            vld1_dup_u16(__builtin_assume_aligned((const u16*)a2, 1)));
        a2 += 2;
        const uint8x8_t va3x01010101 = vreinterpret_u8_u16(
            vld1_dup_u16(__builtin_assume_aligned((const u16*)a3, 1)));
        a3 += 2;
