...
pub fn linalg_slogdet_out(
        input:     &Tensor,
        sign:      &mut Tensor,
        logabsdet: &mut Tensor) -> (&mut Tensor,&mut Tensor) {
...
/**
  ...
  */
pub fn linalg_matrix_rank_out_helper(
        input:     &Tensor,
        atol:      &Tensor,
        rtol:      &Tensor,
        hermitian: bool,
...
pub fn linalg_matrix_rank_out_a(
        input:     &Tensor,
        tol:       &Tensor,
        hermitian: bool,
        result:    &mut Tensor) -> &mut Tensor {
...
pub fn linalg_matrix_rank_out_b(
        input:     &Tensor,
        tol:       Option<f64>,
        hermitian: bool,
        result:    &mut Tensor) -> &mut Tensor {
...
/**
  ...
  |
  */
pub fn matrix_chain_order(tensors: TensorList) -> Vec<Vec<i64>> {
...
pub fn linalg_multi_dot(tensors: TensorList) -> Tensor {
...
pub fn chain_matmul(matrices: TensorList) -> Tensor {
...
/**
  ...
  */
#[inline] pub fn bmm_out_or_baddbmm(
        self_or_result: &mut Tensor,
        batch1:         &Tensor,
        batch2:         &Tensor,
        beta:           &Scalar,
        alpha:          &Scalar,
        is_bmm_out:     bool) -> &mut Tensor {
...
pub fn linalg_norm_matrix_out(
        result:    &mut Tensor,
        self_:     &Tensor,
        opt_ord:   &Option<Scalar>,
        dim:       &[i32],
        keepdim:   bool,
        opt_dtype: Option<ScalarType>) -> &mut Tensor {
...
pub fn linalg_vector_norm_impl(
        self_:      &Tensor,
        scalar_ord: &Scalar,
        opt_dim:    Option<&[i32]>,
        keepdim:    bool,
...
pub fn linalg_matrix_norm_out_a(
        self_:   &Tensor,
        ord:     &Scalar,
        dim:     &[i32],
        keepdim: bool,
...
pub fn linalg_matrix_norm_out_b(
        self_:   &Tensor,
        ord:     StringView,
        dim:     &[i32],
        keepdim: bool,
...
/// Numerical or None norms
///
pub fn linalg_norm_out_with_numerical_or_none_norms(
        self_:     &Tensor,
        opt_ord:   &Option<Scalar>,
        opt_dim:   Option<&[i32]>,
        keepdim:   bool,
...
/// Frobenius and nuclear norms
///
pub fn linalg_norm_out_with_frobenius_and_nuclear_norms(
    self_:     &Tensor,
    ord:       StringView,
    opt_dim:   Option<&[i32]>,
    keepdim:   bool,
...
impl KronImpl {
    ...
    pub fn kron_out(&self, result: &mut Tensor) -> &mut Tensor {
