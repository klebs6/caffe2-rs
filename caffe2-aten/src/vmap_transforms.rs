...
impl MultiBatchVmapTransform {
    ...
    pub fn logical_to_physical(logical_tensors: TensorList) -> VmapPhysicalViewVec {
...
impl MultiBatchVmapTransform {
    ...
    /**
      ...
      |
      */
    pub fn logical_to_physical(&mut self, logical_tensors: TensorList) -> VmapPhysicalViewVec {
...
pub fn get_levels_and_largest_logical_dim(logical_tensors: TensorList) -> (BitSet<kVmapNumLevels>,i64) {
