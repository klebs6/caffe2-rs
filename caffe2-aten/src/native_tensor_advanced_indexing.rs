...
//
// The index is a TensorList containg kLong, kBool
...
//
pub fn get_operator_enum(reduce: StringView) -> ScatterGatherOp {
...
pub fn all_strides_match(tensors: TensorList) -> bool {
...
pub fn shapes_as_str(tensors: TensorList) -> String {
...
pub fn make_info(
        self_: Tensor,
        orig:  &TorchList<Option<Tensor>>) -> AdvancedIndex {
...
pub fn make_index_put_iterator(
        info:  &AdvancedIndex,
        value: &Tensor) -> TensorIterator {
...
pub fn make_index_out_iterator(
        info:   &AdvancedIndex,
        result: &mut Tensor) -> TensorIterator {
...
pub fn index(
        self_:   &Tensor,
        indices: &TorchList<Option<Tensor>>) -> Tensor {
...
pub fn index_out(
    result:  &mut Tensor,
    self_:   &Tensor,
    indices: &TorchList<Option<Tensor>>) -> &mut Tensor {
...
pub fn index_put_a(
        self_:      &Tensor,
        indices:    &TorchList<Option<Tensor>>,
        value:      &Tensor,
        accumulate: bool) -> Tensor {
...
pub fn index_select_out_cpu_dim1(
        result_contig: &mut Tensor,
        self_:         &Tensor,
        index_contig:  &Tensor) -> &mut Tensor {
...
pub fn scatter_impl<T, ReduceStub, FillStub>(
        ...
        reduce:      Option<StringView>)  {
    let reduce: Option<StringView> = reduce.unwrap_or(nullopt);
    todo!();
        /*
...
pub fn masked_select_out_impl_cpu(
        result: &mut Tensor,
        self_:  &Tensor,
        mask:   &Tensor) -> &mut Tensor {
