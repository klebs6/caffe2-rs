...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/cuda/CublasHandlePool.cpp]

pub fn create_cublas_handle(handle: *mut cublas::Handle)  {
...
pub fn destroy_cublas_handle(handle: cublas::Handle)  {
...
pub type CuBlasPoolType = DeviceThreadHandlePool<cublas::Handle,CreateCuBlasHandle,DestroyCuBlasHandle>;

pub fn get_current_cuda_blas_handle() -> cublas::Handle {
