...
pub type OrgqrFn = fn(result: &mut Tensor, tau: &Tensor) -> &mut Tensor;
...
pub fn solve_out(
    ...
    A:        &Tensor,
    solution: &mut Tensor,
    lu:       &mut Tensor) -> (&mut Tensor,&mut Tensor) {
...
/**
  ...
  |
  */
pub fn linalg_solve_out_helper_cpu(
        result: &mut Tensor,
        input:  &mut Tensor,
        infos:  &mut Tensor) -> &mut Tensor {
...
/// 'apply_inverse'
///
pub fn linalg_inv_out_helper_cpu(
        result:      &mut Tensor,
        infos_lu:    &mut Tensor,
        infos_getri: &mut Tensor) -> &mut Tensor {
...
pub fn linalg_inv_ex_out(
        input:        &Tensor,
        check_errors: bool,
        inverse:      &mut Tensor,
        info:         &mut Tensor) -> (&mut Tensor,&mut Tensor) {
...
pub fn cholesky_inverse_out_info(
    result: &mut Tensor,
    infos:  &mut Tensor,
    input:  &Tensor,
    upper:  bool) -> &mut Tensor {
...
/**
  ...
  |
  */
pub fn triangular_solve_out_info(
    result:        &mut Tensor,
    ...
    upper:         bool,
    transpose:     bool,
    unitriangular: bool) -> (&mut Tensor,&mut Tensor) {
...
pub fn triangular_solve_out(
        ...
        unitriangular: bool,
        result:        &mut Tensor,
        clone_a:       &mut Tensor) -> (&mut Tensor,&mut Tensor) {
...
pub fn geqrf_out(
        input: &Tensor,
        QR:    &mut Tensor,
        tau:   &mut Tensor) -> (&mut Tensor,&mut Tensor) {
...
pub fn linalg_qr_out(
        ...
        mode:  StringView,
        Q:     &mut Tensor,
        R:     &mut Tensor) -> (&mut Tensor,&mut Tensor) {
...
/**
  ...
  |
  */
pub fn householder_product_out_helper(
    input:  &Tensor,
    tau:    &Tensor,
    result: &mut Tensor) -> &mut Tensor {
...
/**
  ...
  |
  */
pub fn linalg_eigh_out_info(
    input:                &Tensor,
    values:               &mut Tensor,
    vectors:              &mut Tensor,
    infos:                &mut Tensor,
    compute_eigenvectors: bool,
    uplo_str:             StringView) -> (&mut Tensor,&mut Tensor) {
...
pub fn linalg_eigh_out(
        ...
        uplo:    StringView,
        eigvals: &mut Tensor,
        eigvecs: &mut Tensor) -> (&mut Tensor,&mut Tensor) {
...
pub fn symeig_out(
    ...
    upper:        bool,
    vals:         &mut Tensor,
    vecs:         &mut Tensor) -> (&mut Tensor,&mut Tensor) {
...
pub fn linalg_eig_make_complex_eigenvectors(
    complex_vectors: &mut Tensor,
    complex_values:  &Tensor,
    real_vectors:    &Tensor) -> &mut Tensor {
...
pub fn linalg_eig_out_info(
        input:                &Tensor,
        values:               &mut Tensor,
        vectors:              &mut Tensor,
        infos:                &mut Tensor,
        compute_eigenvectors: bool) -> (&mut Tensor,&mut Tensor) {
...
pub fn linalg_eig_out(
    input:   &Tensor,
    values:  &mut Tensor,
    vectors: &mut Tensor) -> (&mut Tensor,&mut Tensor) {
...
pub fn eig_out(
    ...
    eigenvectors: bool,
    e:            &mut Tensor,
    v:            &mut Tensor) -> (&mut Tensor,&mut Tensor) {
...
pub fn legacy_lstsq_out(
        B:     &Tensor,
        A:     &Tensor,
        b_out: &mut Tensor,
        a_out: &mut Tensor) -> (&mut Tensor,&mut Tensor) {
