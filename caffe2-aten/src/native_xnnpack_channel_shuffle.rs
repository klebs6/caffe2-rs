...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/xnnpack/ChannelShuffle.cpp]
...
pub mod xnnpack {
    ...
    pub fn channel_shuffle(
        ...
        todo!();
          ...
          i64 batch_size = input_padded_contig_nhwc.size(Layout::Activation4D::batch) *
                               input_padded_contig_nhwc.size(Layout::Activation4D::height) *
                               input_padded_contig_nhwc.size(Layout::Activation4D::width);
