...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/core/register_symbols.cpp]
...
pub fn qual_name_for_entry(entry: &Entry) -> String {
...
// and then storing two u16 (or u32 if needed) offsets into
    ...
    pub fn new() -> Self {
      ...
      for (const auto& entry : entries) {
        ...
        sym_to_info_[entry.sym] = {
          entry.ns_sym, move(qual_name), entry.unqual_name};
      }
        */
    }
}
