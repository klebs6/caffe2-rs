...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/mkldnn/Linear.cpp]

#[cfg(not(AT_MKLDNN_ENABLED))]
pub fn mkldnn_linear(
        self_:    &Tensor,
        weight:   &Tensor,
...
pub fn mkldnn_linear(
    ...
    todo!();
      ...
      std::vector<i64> output_size(input_size.begin(), input_size.end() - 1);
...
pub fn mkldnn_linear_backward_input(
    ...
    todo!();
      ...
      std::vector<i64> input_reshaped_size;
