...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/cpu/vec/vec256/vsx/vec256_qint32_vsx.h]
lazy_static!{
    /*
    #pragma once
    ...
    struct Vectorized<c10::qint32> {
     ...
     public:
      ...
      static constexpr usize float_num_vecs() {
        return 1;
      }
      ...
      static Vectorized<c10::qint32> quantize(
        ...
        const vint32 vmin = vec_splats(value_type::min);
        const vint32 vmax = vec_splats(value_type::max);
