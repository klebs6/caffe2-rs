...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/library.cpp]
...
pub fn register_conv_params<const SpatialDim: usize = 2>() -> TorchClass<ConvPackedParamsBase<SpatialDim>> {
...
lazy_static!{
    ...
    TORCH_LIBRARY(quantized, m) {
      ...
      // dequant - batch_norm - quant into quantized::batch_norm
