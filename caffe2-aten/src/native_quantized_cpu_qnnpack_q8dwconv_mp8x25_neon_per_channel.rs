...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/src/q8dwconv/mp8x25-neon-per-channel.c]

pub fn pytorch_q8dwconv_ukernel_mp8x25_per_channel_neon(
        channels:            usize,
        output_width:        usize,
    ...
    todo!();
      ...
      do {
        ...
        const void* w = weights;
        {
          ...
          usize c = channels;
          const u8* kernel_zero_points_ptr =
        ...
        {
          const u8* i0 = input[10];
          const u8* i1 = input[11];
          const u8* i2 = input[12];
          const u8* i3 = input[13];
          const u8* i4 = input[14];
          const u8* i5 = input[15];
          const u8* i6 = input[16];
          const u8* i7 = input[17];
          const u8* i8 = input[18];
          const u8* i9 = input[19];
          output = output_start;
          outacc = outacc32;
        ...
        {
          const u8* i0 = input[20];
          const u8* i1 = input[21];
          const u8* i2 = input[22];
          const u8* i3 = input[23];
          const u8* i4 = input[24];
