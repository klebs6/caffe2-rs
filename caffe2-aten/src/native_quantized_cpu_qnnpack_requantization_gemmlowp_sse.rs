...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/src/requantization/gemmlowp-sse.h]
...
/**
  ...
  | License.
  */
#[inline] pub fn gemmlowp_sse_rdivbypo2_s32(
        x:        __m128i,
        exponent: i32) -> __m128i {
    
    todo!();
        /*
            const __m128i mask =
          _mm_set1_epi32((i32)((UINT64_C(1) << exponent) - UINT64_C(1)));
...
#[inline] pub fn gemmlowp_sse_mul_s32(
    a: __m128i,
    b: __m128i) -> __m128i {
...
#[inline] pub fn gemmlowp_sse_vqrdmulh_s32(
    a: __m128i,
    b: __m128i) -> __m128i {
