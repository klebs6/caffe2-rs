...
pub fn cumsum_c(
        self_: &mut Tensor,
        dim:   i64,
        dtype: Option<ScalarType>) -> &mut Tensor {
...
pub fn logsumexp_out_impl(
        result:  &mut Tensor,
        self_:   &Tensor,
        dims:    &[i32],
        keepdim: bool) -> &mut Tensor {
...
pub fn logsumexp_ouw_With_dims(
    self_:   &Tensor,
    dims:    DimnameList,
    keepdim: bool,
    result:  &mut Tensor) -> &mut Tensor {
...
#[inline] pub fn all_a(
        result: &mut Tensor,
        iter:   &mut TensorIterator) -> &mut Tensor {
...
pub fn std_var_mean_out(
        ...
        correction_opt: Option<i64>,
        keepdim:        bool,
        take_sqrt:      bool) -> (&mut Tensor,&mut Tensor) {
