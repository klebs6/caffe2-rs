...
#[inline] pub fn prepare_matrix_for_cublas<'a>(
        tensor:           &Tensor,
        transpose_tensor: &mut bool) -> MaybeOwned<'a, Tensor> {
...
pub fn prepare_batch_matrix_for_cublas<'a>(
        tensor:           &Tensor,
        transpose_tensor: &mut bool,
        ld_tensor:        &mut i64,
        transpose_result: bool,
        m:                i64,
        n:                i64) -> MaybeOwned<'a, Tensor> {
...
pub fn baddbmm_out_cuda_impl<'a>(
        result: &mut Tensor,
        self_:  &Tensor,
        batch1: &Tensor,
        batch2: &Tensor,
