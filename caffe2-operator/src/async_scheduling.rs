...
pub struct AsyncSchedulingNet {
    base:                AsyncNetBase,
    running:             Mutex<AtomicBool>,
    running_cv:          Condvar,
    processed_tasks_num: AtomicI32,
}

impl Drop for AsyncSchedulingNet {
...
impl AsyncSchedulingNet {
    ...
    #[inline] pub fn is_inline_task(&self, 
        parent_id: i32,
        child_id: i32) -> bool {
    ...
    /**
      | schedule() is not supposed to throw, all
      | exceptions in the ops are caught and
      | reported in the end of the graph's
      | execution, the full graph of tasks is
      | expected to be scheduled
      */
    #[inline] pub fn schedule(&mut self, 
        task_id: i32,
        run_inline: Option<bool>)  
    {
        let run_inline = run_inline.unwrap_or(false);
    ...
    #[inline] pub fn parent_callback(&mut self, parent_id: i32)  {
    ...
    #[inline] pub fn poll_and_schedule(&mut self, task_id: i32)  {
    ...
    #[inline] pub fn finish_run(&mut self)  {
    ...
    #[inline] pub fn cancel_and_finish_async_tasks(&mut self)  {
