...
#[inline] pub fn update_operator_nodes(nodes: &mut Vec<OperatorNode>, chains: &ExecutionChains)  {
...
#[inline] pub fn single_chains(nodes: &mut Vec<OperatorNode>) -> ExecutionChains {
