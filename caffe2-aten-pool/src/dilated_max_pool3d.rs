...
pub fn max_pool3d_with_indices_backward_out_cpu_template<'a>(
...
pub fn max_pool3d_with_indices_out_cpu<'a>(
        input:       &Tensor,
        kernel_size: &[i32],
        stride:      &[i32],
        padding:     &[i32],
...
pub fn max_pool3d_with_indices_backward_out_cpu<'a>(
        grad_output: &Tensor,
        input:       &Tensor,
        kernel_size: &[i32],
        stride:      &[i32],
