...
/**
  ...
  */
pub fn unsupported_random_op<'a,Args>(args: Args) -> Tensor {
...
pub fn unsupported_random_op_mut<Args>(args: Args) -> &'a mut Tensor {
...
lazy_static!{
    ...
    #define TENSOROPTIONS optional<ScalarType>, optional<Layout>, optional<Device>, optional<bool>
      ...
      m.impl("rand.names", unsupportedRandomOp<IntArrayRef, optional<&[Dimname]>, TENSOROPTIONS>);
      m.impl("rand.generator_with_names", unsupportedRandomOp<IntArrayRef, optional<Generator>, optional<&[Dimname]>, TENSOROPTIONS>);
      ...
      m.impl("randn.names", unsupportedRandomOp<IntArrayRef, optional<&[Dimname]>, TENSOROPTIONS>);
      m.impl("randn.generator_with_names", unsupportedRandomOp<IntArrayRef, optional<Generator>, optional<&[Dimname]>, TENSOROPTIONS>);
