...
pub fn relu_quantized_cpu<'a>(qx: &Tensor) -> Tensor {
...
pub fn relu_quantized_cpu_mut(qx: &mut Tensor) -> &'a mut Tensor {
...
pub fn leaky_relu_out_quantized_cpu<'a>(
        self_:  &Tensor,
        negval: &Scalar,
...
pub fn leaky_relu_quantized_cpu_mut<'a>(
        self_:  &mut Tensor,
        negval: &Scalar) -> &'a mut Tensor {
