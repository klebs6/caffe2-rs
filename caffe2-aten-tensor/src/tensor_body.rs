...
impl Tensor {
    ...
    /**
      ...
      | all situations.
      */
    pub fn assign_from_ref<'a>(&mut self, x: &Tensor) -> &'a mut Tensor {
    ...
    pub fn assign_from<'a>(&mut self, x: Tensor) -> &'a mut Tensor {
    ...
    /**
      | \fn void backward(const Tensor & gradient={}, optional<bool> retain_graph=nullopt, bool create_graph=false, optional<&[Tensor]> inputs=nullopt) const;
      |
    ...
    pub fn backward(&self, 
        ...
        // currently does not support optional of &[Tensor] our approach is to replace
    ...
    /**
      ...
      */
    pub fn mutable_grad<'a>(&self) -> &'a mut Tensor {
