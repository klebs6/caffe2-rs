...
pub struct OperandInfo<'a> {
    ...
    /**
      ...
      |
      */
    original_tensor: MaybeOwned<'a, Tensor>,
...
pub mod operand_info {
    ...
    pub type StrideVector = SmallVec<[i64;6]>;
}
...
pub struct TensorIteratorBase<'a> {
    ...
    /**
      ...
      |
      */
    operands:                 SmallVec<[OperandInfo<'a>;4]>,
...
pub mod tensor_iterator_base {
    ...
    pub type PtrVector    = SmallVec<[*mut u8;4]>;
    pub type StrideVector = SmallVec<[i64;6]>;
...
impl<'a> TensorIteratorBase<'a> {
    ...
    pub fn loop_2d_from_1d<T,Loop1d>(&mut self, loop_: &Loop1d) -> T {
...
pub struct TensorIterator<'a> {
    base: TensorIteratorBase<'a>,
}

impl<'a> Default for TensorIterator<'a> {
...
impl<'a> TensorIterator<'a> {
    ...
    pub fn nullary_op(out: &mut Tensor) -> TensorIterator<'a> {
    ...
    pub fn borrowing_nullary_op(out: &Tensor) -> TensorIterator<'a> {
...
pub struct TensorIteratorConfig<'a> {
    tensors:                         SmallVec<[MaybeOwned<'a, Tensor>;4]>,
    num_outputs:                     i32, // default = 0
...
impl<'a> TensorIteratorConfig<'a> {
    ...
    /**
      ...
      |
      */
    pub fn add_output(&mut self, output: &Tensor) -> &'a mut TensorIteratorConfig {
    ...
    pub fn add_input(&mut self, input: &Tensor) -> &'a mut TensorIteratorConfig {
    ...
    /**
      ...
      */
    pub fn add_owned_output(&mut self, output: &Tensor) -> &'a mut TensorIteratorConfig {
    ...
    pub fn add_owned_input(&mut self, input: &Tensor) -> &'a mut TensorIteratorConfig {
    ...
    /**
      ...
      |
      */
    pub fn add_borrowed_output(&mut self, output: &Tensor) -> &'a mut TensorIteratorConfig {
    ...
    pub fn add_borrowed_input(&mut self, input: &Tensor) -> &'a mut TensorIteratorConfig {
    ...
    /**
      ...
      |
      */
    pub fn set_check_mem_overlap(&mut self, check_mem_overlap: bool) -> &'a mut TensorIteratorConfig {
    ...
    /**
      ...
      */
    pub fn check_all_same_dtype(&mut self, check_all_same_dtype: bool) -> &'a mut TensorIteratorConfig {
    ...
    /**
      ...
      */
    pub fn check_all_same_device(&mut self, check_all_same_device: bool) -> &'a mut TensorIteratorConfig {
    ...
    /**
      ...
      |
      */
    pub fn enforce_safe_casting_to_output(&mut self, enforce_safe_casting_to_output: bool) -> &'a mut TensorIteratorConfig {
    ...
    /**
      ...
      |
      */
    pub fn enforce_linear_iteration(&mut self, enforce_linear_iteration: bool) -> &'a mut TensorIteratorConfig {
    ...
    /**
      ...
      |
      */
    pub fn promote_inputs_to_common_dtype(&mut self, promote_inputs_to_common_dtype: bool) -> &'a mut TensorIteratorConfig {
    ...
    /**
      ...
      |   type.
      */
    pub fn promote_integer_inputs_to_float(&mut self, promote_integer_inputs_to_float: bool) -> &'a mut TensorIteratorConfig {
    ...
    pub fn is_reduction(&mut self, is_reduction: bool) -> &'a mut TensorIteratorConfig {
    ...
    pub fn allow_cpu_scalars(&mut self, allow_cpu_scalars: bool) -> &'a mut TensorIteratorConfig {
    ...
    /**
      ...
      |
      */
    pub fn cast_common_dtype_to_outputs(&mut self, cast_common_dtype_to_outputs: bool) -> &'a mut TensorIteratorConfig {
    ...
    pub fn resize_outputs(&mut self, resize_outputs: bool) -> &'a mut TensorIteratorConfig {
    ...
    pub fn declare_static_dtype_and_device(&mut self, 
        dtype:  ScalarType,
        device: Device) -> &'a mut TensorIteratorConfig {
    ...
    pub fn declare_static_shape(&mut self, shape: &[i32]) -> &'a mut TensorIteratorConfig {
    ...
    pub fn declare_static_shape(&mut self, 
        shape:       &[i32],
        squash_dims: &[i32]) -> &'a mut TensorIteratorConfig {
...
pub struct SplitUntil32BitIterator<'a> {

    /**
      | stack of TensorIterators to be split
      |
      */
    vec: Vec<Box<TensorIterator<'a>>>,
}

impl<'a> PartialEq<SplitUntil32BitIterator<'a>> for SplitUntil32BitIterator<'a>  {
    
    #[inline] fn eq(&self, other: &SplitUntil32BitIterator<'a>) -> bool {
        todo!();
        /*
...
impl<'a> SplitUntil32BitIterator<'a> {
...
/**
  ...
  |
  */
pub struct SplitUntil32Bit<'a> {
    iter: &'a TensorIteratorBase<'a>,
}

impl<'a> SplitUntil32Bit<'a> {
...
impl<'a> TensorIteratorBase<'a> {
    ...
    pub fn get_base_ptrs(&self) -> SmallVec<[*mut u8;4]> {
...
impl<'a> SplitUntil32BitIterator<'a> {
    ...
    pub fn operator_star(&self) -> &'a mut TensorIterator {
