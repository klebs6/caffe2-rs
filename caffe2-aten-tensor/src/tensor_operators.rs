...
impl Tensor {
    ...
    #[inline] pub fn assign_from<'a>(&mut self, rhs: &Tensor) -> &'a mut Tensor {
    ...
    #[inline] pub fn assign_from<'a>(&mut self, v: Scalar) -> &'a mut Tensor {
...
impl Index<i64> for Tensor {
    ...
    fn index<'a>(&self, index: i64) -> &Self::Output {
        todo!();
        /*
