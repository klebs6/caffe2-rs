...
pub fn random_impl<'a,random_kernel, RNG>(
        self_:     &mut Tensor,
...
pub fn random_from_to_impl<'a,random_from_to_kernel, RNG>(
        self_:     &mut Tensor,
        from:      i64,
        to_opt:    Option<i64>,
        generator: Option<Generator>) -> &'a mut Tensor {
...
pub fn normal_impl_f64_f64<'a,normal_kernel, RNG>(
        self_: &mut Tensor,
        mean:  f64,
        std:   f64,
...
pub fn normal_out_impl_tensor_f64<'a,normal_kernel, RNG>(
        output: &mut Tensor,
        mean:   &Tensor,
        std:    f64,
        gen:    Option<Generator>) -> &'a mut Tensor {
...
pub fn normal_out_impl_f64_tensor<'a,normal_kernel, RNG>(
        output: &mut Tensor,
        mean:   f64,
        std:    &Tensor,
        gen:    Option<Generator>) -> &'a mut Tensor {
...
pub fn normal_out_impl_tensor_tensor<'a,normal_kernel, RNG>(
        output: &mut Tensor,
        mean:   &Tensor,
        std:    &Tensor,
        gen:    Option<Generator>) -> &'a mut Tensor {
...
pub fn uniform_impl<'a,uniform_kernel, RNG>(
        self_:     &mut Tensor,
        from:      f64,
        to:        f64,
        generator: Option<Generator>) -> &'a mut Tensor {
...
pub fn log_normal_impl<'a,log_normal_kernel, RNG>(
        self_: &mut Tensor,
        mean:  f64,
        std:   f64,
        gen:   Option<Generator>) -> &'a mut Tensor {
...
pub fn geometric_impl<'a,geometric_kernel, RNG>(
        self_: &mut Tensor,
        p:     f64,
        gen:   Option<Generator>) -> &'a mut Tensor {
...
pub fn exponential_impl<'a,exponential_kernel, RNG>(
        self_:  &mut Tensor,
        lambda: f64,
        gen:    Option<Generator>) -> &'a mut Tensor {
...
pub fn cauchy_impl<'a,cauchy_kernel, RNG>(
        self_:  &mut Tensor,
        median: f64,
        sigma:  f64,
        gen:    Option<Generator>) -> &'a mut Tensor {
...
pub fn bernoulli_impl_a<'a,bernoulli_tensor_kernel, RNG>(
        self_: &mut Tensor,
        p:     &Tensor,
        gen:   Option<Generator>) -> &'a mut Tensor {
...
pub fn bernoulli_impl_b<'a,bernoulli_scalar_kernel, RNG>(
        self_: &mut Tensor,
        p:     f64,
        gen:   Option<Generator>) -> &'a mut Tensor {
...
pub fn bernoulli_out_impl<'a,bernoulli_tensor_kernel, RNG>(
        result: &mut Tensor,
        self_:  &Tensor,
        gen:    Option<Generator>) -> &'a mut Tensor {
