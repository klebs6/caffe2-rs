...
pub fn rf_tls<'a>() -> &'a mut RecordFunctionTLS {
...
pub fn coinflip_tls<'a>() -> &'a mut CoinflipTLS {
...
pub fn get_record_function_tls<'a>() -> &'a RecordFunctionTLS {
...
/**
  ...
  |
  */
pub fn manager<'a>() -> &'a mut CallbackManager {
