...
pub fn scalar_to_tensor_default_dtype(
    ...
    let device = device.unwrap_or(DeviceType::kCPU);
...
pub fn max_out_a<'a>(
        ...
        keepdim:     bool,
        max:         &mut Tensor,
        max_indices: &mut Tensor) -> (&'a mut Tensor,&'a mut Tensor) {
...
pub fn min_out_b<'a>(
        ...
        keepdim:     bool,
        min:         &mut Tensor,
        min_indices: &mut Tensor) -> (&'a mut Tensor,&'a mut Tensor) {
...
pub fn clamp_d<'a>(
        self_: &mut Tensor,
        min:   &Option<Tensor>,
        max:   &Option<Tensor>) -> &'a mut Tensor {
...
pub fn clamp_max_d<'a>(
        self_: &mut Tensor,
        max:   &Tensor) -> &'a mut Tensor {
...
pub fn clamp_min_c<'a>(
    self_: &mut Tensor,
    min:   &Scalar) -> &'a mut Tensor {
...
pub fn clamp_min_d<'a>(
    self_: &mut Tensor,
    min:   &Tensor) -> &'a mut Tensor {
