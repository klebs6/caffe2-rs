...
#[inline] pub fn fc_shape_inference(
    def:   &OperatorDef,
    input: &Vec<TensorShape>,
    pretransposed_weight: bool) -> Vec<TensorShape> 
{
    todo!();
    /*
...
#[inline] pub fn cost_inference_for_fc(
    def:   &OperatorDef,
    input: &Vec<TensorShape>,
    pretransposed_weight: Option<bool>) -> OpSchemaCost 
{
    let pretransposed_weight: bool = pretransposed_weight.unwrap_or(false);
...
#[inline] pub fn fCGradient_shape_inference(
    def:   &OperatorDef,
    input: &Vec<TensorShape>,
    pretransposed_weight: bool) -> Vec<TensorShape> {
...
#[inline] pub fn cost_inference_for_fcgradient(
    def:   &OperatorDef,
    input: &Vec<TensorShape>,
    pretransposed_weight: bool) -> OpSchemaCost {
