...
#ACTIVE := caffe2-aten
#ACTIVE := caffe2-aten-accessor
#ACTIVE := caffe2-aten-activation
#ACTIVE := caffe2-aten-adaptive
#ACTIVE := caffe2-aten-alias
#ACTIVE := caffe2-aten-apply
#ACTIVE := caffe2-aten-autocast
#ACTIVE := caffe2-aten-autograd
#ACTIVE := caffe2-aten-batch-norm
#ACTIVE := caffe2-aten-batching
#ACTIVE := caffe2-aten-benchmarks
#ACTIVE := caffe2-aten-bias
#ACTIVE := caffe2-aten-binary-ops
#ACTIVE := caffe2-aten-blas
...
#ACTIVE := caffe2-aten-elu
#ACTIVE := caffe2-aten-embedding
#ACTIVE := caffe2-aten-empty
#ACTIVE := caffe2-aten-fallback
#ACTIVE := caffe2-aten-fbgemm
#ACTIVE := caffe2-aten-fill
#ACTIVE := caffe2-aten-float
#ACTIVE := caffe2-aten-function
#ACTIVE := caffe2-aten-glu
#ACTIVE := caffe2-aten-grid
#ACTIVE := caffe2-aten-guard
...
#ACTIVE := caffe2-aten-linear
#ACTIVE := caffe2-aten-list
#ACTIVE := caffe2-aten-loss
#ACTIVE := caffe2-aten-math
#ACTIVE := caffe2-aten-matrix
#ACTIVE := caffe2-aten-memory
#ACTIVE := caffe2-aten-metal
#ACTIVE := caffe2-aten-miopen
#ACTIVE := caffe2-aten-mkl
#ACTIVE := caffe2-aten-mkldnn
#ACTIVE := caffe2-aten-moments
#ACTIVE := caffe2-aten-mul
#ACTIVE := caffe2-aten-multinomial
#ACTIVE := caffe2-aten-names
#ACTIVE := caffe2-aten-nnapi
#ACTIVE := caffe2-aten-nnpack
#ACTIVE := caffe2-aten-norm
#ACTIVE := caffe2-aten-op-registration
#ACTIVE := caffe2-aten-pack
#ACTIVE := caffe2-aten-pad
#ACTIVE := caffe2-aten-parallel
#ACTIVE := caffe2-aten-param
#ACTIVE := caffe2-aten-pointwise
#ACTIVE := caffe2-aten-pool
#ACTIVE := caffe2-aten-prune
#ACTIVE := caffe2-aten-quantize
#ACTIVE := caffe2-aten-quantized
#ACTIVE := caffe2-aten-quantized-cpu
#ACTIVE := caffe2-aten-rand
#ACTIVE := caffe2-aten-range
#ACTIVE := caffe2-aten-reduce
#ACTIVE := caffe2-aten-reshape
#ACTIVE := caffe2-aten-resize
#ACTIVE := caffe2-aten-rnn
#ACTIVE := caffe2-aten-scalar
#ACTIVE := caffe2-aten-scatter
#ACTIVE := caffe2-aten-shuffle
#ACTIVE := caffe2-aten-sobol
#ACTIVE := caffe2-aten-softmax
#ACTIVE := caffe2-aten-sort
#ACTIVE := caffe2-aten-sparse
#ACTIVE := caffe2-aten-spectral
#ACTIVE := caffe2-aten-stack
#ACTIVE := caffe2-aten-sum
#ACTIVE := caffe2-aten-summary
#ACTIVE := caffe2-aten-tensor
#ACTIVE := caffe2-aten-test
#ACTIVE := caffe2-aten-th
#ACTIVE := caffe2-aten-transform
#ACTIVE := caffe2-aten-triangular
#ACTIVE := caffe2-aten-type
#ACTIVE := caffe2-aten-unary
#ACTIVE := caffe2-aten-unfold
#ACTIVE := caffe2-aten-unique
#ACTIVE := caffe2-aten-upsample
#ACTIVE := caffe2-aten-vmap
#ACTIVE := caffe2-aten-vulkan
#ACTIVE := caffe2-aten-windows
#ACTIVE := caffe2-aten-xnnpack
#ACTIVE := caffe2-qnnpack-add
#ACTIVE := caffe2-qnnpack-bench
#ACTIVE := caffe2-qnnpack-clamp
#ACTIVE := caffe2-qnnpack-conv
#ACTIVE := caffe2-qnnpack-deconv
#ACTIVE := caffe2-qnnpack-fc
#ACTIVE := caffe2-qnnpack-gemm
#ACTIVE := caffe2-qnnpack-hardsigmoid
#ACTIVE := caffe2-qnnpack-hardswish
#ACTIVE := caffe2-qnnpack-hgemm
#ACTIVE := caffe2-qnnpack-indirection
#ACTIVE := caffe2-qnnpack-init
#ACTIVE := caffe2-qnnpack-log
#ACTIVE := caffe2-qnnpack-lut
#ACTIVE := caffe2-qnnpack-math
#ACTIVE := caffe2-qnnpack-memory
#ACTIVE := caffe2-qnnpack-operator
#ACTIVE := caffe2-qnnpack-pack
#ACTIVE := caffe2-qnnpack-params
#ACTIVE := caffe2-qnnpack-pool
#ACTIVE := caffe2-qnnpack-q8avgpool
#ACTIVE := caffe2-qnnpack-q8conv
#ACTIVE := caffe2-qnnpack-q8dwconv
#ACTIVE := caffe2-qnnpack-q8gavgpool
#ACTIVE := caffe2-qnnpack-q8gemm
#ACTIVE := caffe2-qnnpack-q8gemm-sparse
#ACTIVE := caffe2-qnnpack-q8vadd
#ACTIVE := caffe2-qnnpack-reduce
#ACTIVE := caffe2-qnnpack-relu
#ACTIVE := caffe2-qnnpack-requantization
#ACTIVE := caffe2-qnnpack-rmax
#ACTIVE := caffe2-qnnpack-sgemm
#ACTIVE := caffe2-qnnpack-shuffle
#ACTIVE := caffe2-qnnpack-sigmoid
#ACTIVE := caffe2-qnnpack-softargmax
#ACTIVE := caffe2-qnnpack-tanh
#ACTIVE := caffe2-qnnpack-u8clamp
#ACTIVE := caffe2-qnnpack-u8lut
#ACTIVE := caffe2-qnnpack-u8maxpool
#ACTIVE := caffe2-qnnpack-u8rmax
#ACTIVE := caffe2-qnnpack-x8lut
#ACTIVE := caffe2-qnnpack-x8zip
