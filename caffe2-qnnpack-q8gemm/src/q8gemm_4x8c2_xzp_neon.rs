...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/src/q8gemm/4x8c2-xzp-neon.c]

pub fn pytorch_q8gemm_xzp_ukernel_4x8c2_neon(
        mr:                    Size,
        nr:                    Size,
        k:                     Size,
        a:                     *const u8,
        ...
        c:                     *mut u8,
        c_stride:              Size,
        requantization_params: [PyTorchQnnpQ31RequantizationParams; 1])  {
    ...
    todo!();
      ...
      const u8* a0 = a;
      const u8* a1 = a0;
      const i32* a_sum0 = a_sum;
      const i32* a_sum1 = a_sum0;
      if (mr >= 2) {
        a1 += a_stride;
        a_sum1 += 1;
      }
      const u8* a2 = a1;
      const i32* a_sum2 = a_sum1;
      if (mr > 2) {
        a2 += a_stride;
        a_sum2 += 1;
      }
      const u8* a3 = a2;
      const i32* a_sum3 = a_sum2;
      if (mr == 4) {
        a3 += a_stride;
        a_sum3 += 1;
      }
