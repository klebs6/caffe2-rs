...
//-------------------------------------------[.cpp/pytorch/aten/src/ATen/native/quantized/cpu/qnnpack/src/q8gemm/8x8-neon.c]

pub fn pytorch_q8gemm_ukernel_8x8_neon(
        mr:                   usize,
        nr:                   usize,
        k:                    usize,
        a:                    *const u8,
    ...
    todo!();
      ...
      const u8* a4 = (const u8*)((uintptr_t)a3 + a_stride);
      if (mr <= 4) {
        a4 = a3;
      }
      const u8* a5 = (const u8*)((uintptr_t)a4 + a_stride);
      if (mr < 6) {
        a5 = a4;
      }
      const u8* a6 = (const u8*)((uintptr_t)a5 + a_stride);
      if (mr <= 6) {
        a6 = a5;
      }
      const u8* a7 = (const u8*)((uintptr_t)a6 + a_stride);
      if (mr != 8) {
        a7 = a6;
      }

      const uint8x8_t va_zero_point =
          vld1_dup_u8((const u8*)&quantization_params->neon.input_zero_point);
      const uint8x8_t vb_zero_point =
          vld1_u8((const u8*)&quantization_params->neon.kernel_zero_points
      ...
      for (; k >= 8; k -= 8) {
        ...
        vacc4x0123 = vmlal_lane_s16(
            vacc4x0123, vget_low_s16(vxb01234567c2), vget_low_s16(vxa4), 2);
        vacc4x4567 = vmlal_lane_s16(
            vacc4x4567, vget_high_s16(vxb01234567c2), vget_low_s16(vxa4), 2);
        vacc5x0123 = vmlal_lane_s16(
            vacc5x0123, vget_low_s16(vxb01234567c2), vget_low_s16(vxa5), 2);
        vacc5x4567 = vmlal_lane_s16(
            vacc5x4567, vget_high_s16(vxb01234567c2), vget_low_s16(vxa5), 2);
        vacc6x0123 = vmlal_lane_s16(
            vacc6x0123, vget_low_s16(vxb01234567c2), vget_low_s16(vxa6), 2);
        vacc6x4567 = vmlal_lane_s16(
        ...
        vacc7x4567 = vmlal_lane_s16(
            vacc7x4567, vget_high_s16(vxb01234567c3), vget_low_s16(vxa7), 3);
        ...
        vacc4x0123 = vmlal_lane_s16(
            vacc4x0123, vget_low_s16(vxb01234567c5), vget_high_s16(vxa4), 1);
        vacc4x4567 = vmlal_lane_s16(
            vacc4x4567, vget_high_s16(vxb01234567c5), vget_high_s16(vxa4), 1);
        vacc5x0123 = vmlal_lane_s16(
            vacc5x0123, vget_low_s16(vxb01234567c5), vget_high_s16(vxa5), 1);
        vacc5x4567 = vmlal_lane_s16(
            vacc5x4567, vget_high_s16(vxb01234567c5), vget_high_s16(vxa5), 1);
        vacc6x0123 = vmlal_lane_s16(
            vacc6x0123, vget_low_s16(vxb01234567c5), vget_high_s16(vxa6), 1);
        vacc6x4567 = vmlal_lane_s16(
            vacc6x4567, vget_high_s16(vxb01234567c5), vget_high_s16(vxa6), 1);
        vacc7x0123 = vmlal_lane_s16(
            vacc7x0123, vget_low_s16(vxb01234567c5), vget_high_s16(vxa7), 1);
        vacc7x4567 = vmlal_lane_s16(
      ...
      u8* c4 = (u8*)((uintptr_t)c3 + c_stride);
      if (mr <= 4) {
        c4 = c3;
      }
      u8* c5 = (u8*)((uintptr_t)c4 + c_stride);
      if (mr < 6) {
        c5 = c4;
      }
      u8* c6 = (u8*)((uintptr_t)c5 + c_stride);
      if (mr <= 6) {
        c6 = c5;
      }
      u8* c7 = (u8*)((uintptr_t)c6 + c_stride);
      if (mr != 8) {
        c7 = c6;
      }
      if (nr == 8) {
